...
DOCUMENT_ID: SIGN_CORE_CARD_CYRILLIC_CAPITAL_IZHITSA_U0474_GEN3_v0_3_EN
...
TRANSLATION_NOTE: English mirror of SIGN_CORE_CARD_CYRILLIC_CAPITAL_IZHITSA_U0474_GEN3_v0_3_RU (authoritative). Codepoints, field names and formulas identical. Homoglyph sign: core law is LOOKS_SAME ≠ IS_SAME. DRAFT for our work (Vakhter); conveyor is a separate project.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_CYRILLIC_CAPITAL_IZHITSA_U0474_GEN3_v0_3_EN
CODEPOINT: U+0474
VISIBLE_FORM: Ѵ
...
DISPLAY_NAME: Cyrillic "Ѵ" capital Izhitsa (homoglyph of Latin capital V)
...
SIGN_CATEGORY:
  - Cyrillic capital Izhitsa — a Church Slavonic letter (sounds /i/ or /v/)
  - homoglyph of Latin capital "V" (U+0056)
  - potential carrier of homoglyph / IDN spoofing when scripts are mixed

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_CAPITAL_V — Cyrillic Ѵ (U+0474) is NOT Latin V (U+0056); a different codepoint in Church Slavonic (sounds /i/ or /v/)
...
SAFE_CASES:
  ...
  SAFE_CASE_002:
    INPUT: "Ѵаковъ" (Church Slavonic)
    CONTEXT: single-script native text
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAPITAL_IZHITSA_FORM ≠ EFFECT
  SAFE_CASE_003:
    INPUT: "Ѵсанъ" (Church Slavonic)
    CONTEXT: single-script native text
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAPITAL_IZHITSA_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_004:
    INPUT: "Ѵмень" (Church Slavonic)
    CONTEXT: single-script native text
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAPITAL_IZHITSA_FORM ≠ EFFECT
  SAFE_CASE_005:
    INPUT: "Ѵрода" (Church Slavonic)
    CONTEXT: single-script native text
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAPITAL_IZHITSA_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_006:
    INPUT: "Ѵсонъ" (Church Slavonic)
    CONTEXT: single-script native text
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAPITAL_IZHITSA_FORM ≠ AUTOMATICALLY_SPOOF
...
RISK_CASES:
  ...
  RISK_CASE_002:
    ...
    INPUT: "Ѵimeo" (a look-alike inside the token `Vimeo`)
    CONTEXT: a look-alike inside the token `Vimeo`
    RISK: CRITICAL
    ATTACK: the string is machine-≠ Vimeo, but a human sees no difference
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_CAPITAL_LETTER_V ≠ CYRILLIC_CAPITAL_IZHITSA_FORM (the primary impersonation target; visually identical in many fonts)
  CONFUSABLE_002:
    VISIBLE_FORM: Ｖ
    CODEPOINT: U+FF36
    NAME: FULLWIDTH LATIN CAPITAL LETTER V
    RISK: MEDIUM
    RULE: FULLWIDTH_LATIN_CAPITAL_LETTER_V ≠ CYRILLIC_CAPITAL_IZHITSA_FORM (a full-width Latin form; a different compatibility form)
  CONFUSABLE_003:
    VISIBLE_FORM: 𝖵
    CODEPOINT: U+1D5B5
    NAME: MATHEMATICAL SANS-SERIF CAPITAL V
    RISK: MEDIUM
    RULE: MATHEMATICAL_SANS_SERIF_CAPITAL_V ≠ CYRILLIC_CAPITAL_IZHITSA_FORM (a math-alphanumeric styled Latin letter used to dodge simple filters)
  CONFUSABLE_004:
    VISIBLE_FORM: 𝐕
    CODEPOINT: U+1D415
    NAME: MATHEMATICAL BOLD CAPITAL V
    RISK: LOW
    RULE: MATHEMATICAL_BOLD_CAPITAL_V ≠ CYRILLIC_CAPITAL_IZHITSA_FORM (a bold-styled Latin letter)
  CONFUSABLE_005:
    VISIBLE_FORM: 𝑉
    CODEPOINT: U+1D449
    NAME: MATHEMATICAL ITALIC CAPITAL V
    RISK: LOW
    RULE: MATHEMATICAL_ITALIC_CAPITAL_V ≠ CYRILLIC_CAPITAL_IZHITSA_FORM (an italic-styled Latin letter)
  CONFUSABLE_006:
    VISIBLE_FORM: 𝚅
    CODEPOINT: U+1D685
    NAME: MATHEMATICAL MONOSPACE CAPITAL V
    RISK: LOW
    RULE: MATHEMATICAL_MONOSPACE_CAPITAL_V ≠ CYRILLIC_CAPITAL_IZHITSA_FORM (a monospace-styled Latin letter)
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: substitution of Latin V (U+0056) with Cyrillic Ѵ (U+0474) in a brand domain
