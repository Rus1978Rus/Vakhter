...
DOCUMENT_ID: SIGN_CORE_CARD_GREEK_CAPITAL_TAU_U03A4_GEN3_v0_3_EN
...
TRANSLATION_NOTE: English mirror of SIGN_CORE_CARD_GREEK_CAPITAL_TAU_U03A4_GEN3_v0_3_RU (authoritative). Codepoints, field names and formulas identical. Homoglyph sign: core law is LOOKS_SAME ≠ IS_SAME. DRAFT for our work (Vakhter); conveyor is a separate project.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_GREEK_CAPITAL_TAU_U03A4_GEN3_v0_3_EN
CODEPOINT: U+03A4
VISIBLE_FORM: Τ
...
DISPLAY_NAME: Greek "Τ" capital tau (homoglyph of Latin capital T)
...
SIGN_CATEGORY:
  - Greek capital letter Tau (sounds /t/; legitimate in Greek script)
  - homoglyph of Latin capital "T" (U+0054)
  - potential carrier of homoglyph / IDN spoofing when scripts are mixed

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_CAP_T — Greek Τ (U+03A4) is NOT Latin T (U+0054); a different codepoint in a different script
  2. NOT_SAME_STRING_AS_LATIN — a string with Greek Τ is not machine-equal to its Latin twin
  3. NOT_BRAND_NAME_PROOF — "ΤESLA" does not prove a link to the Tesla brand
  ...
  12. NOT_INTERCHANGEABLE_IN_IDENTIFIERS — in an identifier/domain, T→Τ changes the entity
...
NOTE: Greek "Τ" capital tau is a stable letter with no cultural precession of functions. "Homoglyph" is not an epoch but a property of visual coincidence with Latin T, co-existing with the letter's legit function. The danger is contextual (mixed scripts), not epochal — so SEMANTIC_EPOCH_TRACKER does not apply.
LAYER_ANOMALY:
...
SAFE_CASES:
  SAFE_CASE_001:
    INPUT: "Τροία και Μυκήνες" (Troy and Mycenae, Greek)
    CONTEXT: ordinary Greek text (single script)
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_CAP_TAU_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_002:
    INPUT: "Τέχνη και επιστήμη" (art and science, Greek)
    CONTEXT: a Greek phrase where "Τ" is an ordinary capital
    EXPECTED: INFO
    RISK: NONE
  ...
  SAFE_CASE_003:
    ...
    GUARD: GREEK_CAP_TAU_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_004:
    INPUT: "Τα Επτάνησα" (the Ionian Islands, Greek)
    CONTEXT: single-script Greek phrase
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_CAP_TAU_FORM ≠ EFFECT
  SAFE_CASE_005:
    INPUT: "Τετάρτη και Πέμπτη" (Wednesday and Thursday, Greek)
    CONTEXT: Greek words beginning with "Τ"
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_CAP_TAU_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_006:
    INPUT: "Τηλέμαχος και Οδυσσέας" (Telemachus and Odysseus, Greek)
...
RISK_CASES:
  RISK_CASE_001:
    ...
    INPUT: "ΤESLA-account.com" (Greek Τ at the start of a brand)
    CONTEXT: IDN/brand spoof — the token looks like TESLA but the first char is Greek
    RISK: CRITICAL
    ATTACK: replacing Latin T with Greek Τ yields a visually identical brand the attacker registers
    GUARD: GREEK_CAP_TAU_FORM ≠ LATIN_CAP_T
  RISK_CASE_002:
    NAME: ALLCAPS_BRAND_SUBSTITUTION
    INPUT: "ΤMOBILE-rewards.com" (Greek Τ in an all-caps brand)
  ...
  RISK_CASE_003:
    ...
    INPUT: "@ΤinderSupport" (Greek Τ in a handle)
  ...
  RISK_CASE_004:
    ...
    INPUT: "ΤRUE" (Greek Τ bypasses a "TRUE" blocklist)
  ...
  RISK_CASE_005:
    ...
    INPUT: "billing@Τwitch-secure.example" (Greek Τ in the mail domain)
  ...
  RISK_CASE_006:
    ...
    INPUT: "ΤNΤ" (two Greek Τ around a Latin N, imitating TNT)
    CONTEXT: multiple substitutions in one all-caps token (Τ Greek, N Latin — a script mix)
    RISK: HIGH
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_CAP_T ≠ GREEK_CAP_TAU (the primary impersonation target; visually identical in many fonts)
  CONFUSABLE_002:
    VISIBLE_FORM: Т
    CODEPOINT: U+0422
    NAME: CYRILLIC CAPITAL LETTER TE
    RISK: HIGH
    RULE: CYRILLIC_CAP_TE ≠ GREEK_CAP_TAU (a third script with the same T-shape; complicates detection)
  CONFUSABLE_003:
    VISIBLE_FORM: 𝗧
    CODEPOINT: U+1D5E7
    NAME: MATHEMATICAL SANS-SERIF BOLD CAPITAL T
    RISK: MEDIUM
    RULE: MATH_SANS_CAP_T ≠ GREEK_CAP_TAU (a math-alphanumeric styled Latin T used to dodge simple filters)
  CONFUSABLE_004:
    VISIBLE_FORM: Ｔ
    CODEPOINT: U+FF34
    NAME: FULLWIDTH LATIN CAPITAL LETTER T
    RISK: MEDIUM
    RULE: FULLWIDTH_CAP_T ≠ GREEK_CAP_TAU (a full-width Latin T; a different compatibility form)
  CONFUSABLE_005:
    VISIBLE_FORM: Ⲧ
    CODEPOINT: U+2CA6
    NAME: COPTIC CAPITAL LETTER TAU
    RISK: LOW
    RULE: COPTIC_TAU ≠ GREEK_CAP_TAU (a Coptic letter with the same T-shape)
  CONFUSABLE_006:
    VISIBLE_FORM: 𝐓
    CODEPOINT: U+1D413
    NAME: MATHEMATICAL BOLD CAPITAL T
    RISK: LOW
    RULE: MATH_BOLD_CAP_T ≠ GREEK_CAP_TAU (a bold-styled Latin T)

CONTRADICTION_GUARDS:
  CG1:
    TRIGGER: "the brand `ΤESLA` is Tesla"
    RESPONSE: GREEK_CAP_TAU_FORM ≠ LATIN_CAP_T
    RULE: the first char is Greek capital tau; the registrable domain/name is different — DNS decides, not the eye
  CG2:
    TRIGGER: "a string with Greek Τ equals its Latin spelling"
    RESPONSE: GREEK_CAP_TAU_FORM ≠ SAME_CODEPOINT_AS_LATIN
    RULE: different codepoints → machine-different strings
  CG3:
    TRIGGER: "any Greek Τ in text is an attack"
  ...
  CG4:
    ...
    RULE: Greek Τ is outside ASCII; a Latin filter will not match it
  CG5:
    TRIGGER: "the handle `@ΤinderSupport` is the same account as @TinderSupport"
    RESPONSE: GREEK_CAP_TAU_FORM ≠ VERIFICATION
    RULE: visual similarity does not identify an account
  CG6:
    TRIGGER: "swapping T→Τ in an identifier is harmless"
...
PHAGO_ENTITY_MIMICRY:
  PE_001:
    ...
    RISK: CRITICAL
    NOTE: Greek Τ mimics the NAME itself of a verified brand (not merely structure) — direct mimicry of an entity's existence. This is why the registry flags the sign PHAGO ●; commercial lookalike defenses often miss this class.
  PE_002:
    INPUT: "@ΤinderSupport"
    TYPE: PHAGO_ENTITY_MIMICRY
    RISK: HIGH
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: substitution of Latin T (U+0054) with Greek Τ (U+03A4) in a brand domain
  A2: mixing Greek Τ with Cyrillic Т / math sans-serif T to complicate detection
CATEGORY_B: CONTEXT_INJECTION (2)
  B1: Greek Τ bypasses a Latin-keyword blocklist (ΤRUE)
  B2: Greek Τ in a mail domain (billing@Τwitch-secure.example) for phishing
CATEGORY_C: SEQUENCE_MANIPULATION (2)
  C1: the mixed token `ΤESLA` (SC1) — scripts within one word
  C2: multiple substitution `ΤNΤ` (SC2) onto a target acronym
CATEGORY_D: SEMANTIC_MIMICRY (2)
  D1: the handle `@ΤinderSupport` imitates a brand account
  D2: "Τwitch-secure" — a look-alike in a pseudo-official name
CATEGORY_E: PHAGO_ENTITY_MIMICRY (2)
  E1: `ΤESLA-account.com` — mimicry of a brand name (PE_001)
  E2: `@ΤinderSupport` — mimicry of an official account (PE_002)
...
============================================================
MUTATION_01:
  CLAIM: `ΤESLA-account.com` with Greek Τ is Tesla's domain
  EXPECTED: FAIL_BRAND_NAME_MIMICRY
  RESULT: FAIL
MUTATION_02:
  CLAIM: a string with Greek Τ is machine-equal to its Latin spelling
  EXPECTED: FAIL_CODEPOINT_IDENTITY_MIMICRY
  RESULT: FAIL
MUTATION_03:
  CLAIM: any Greek Τ in text is an attack
  EXPECTED: FAIL_OVERBLOCK_MIMICRY (the inverse error: genuine Greek is not a spoof)
  RESULT: FAIL
MUTATION_04:
  CLAIM: an ASCII filter on "TRUE" will catch "ΤRUE"
  EXPECTED: FAIL_ASCII_COVERAGE_MIMICRY
  RESULT: FAIL
MUTATION_05:
  CLAIM: the handle `@ΤinderSupport` is the same account as `@TinderSupport`
  EXPECTED: FAIL_IDENTITY_MIMICRY
  RESULT: FAIL
MUTATION_06:
  CLAIM: swapping T→Τ in an identifier is harmless
