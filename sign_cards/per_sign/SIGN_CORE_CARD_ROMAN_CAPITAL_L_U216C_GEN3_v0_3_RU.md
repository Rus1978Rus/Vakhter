...
DOCUMENT_ID: SIGN_CORE_CARD_ROMAN_CAPITAL_L_U216C_GEN3_v0_3_RU
...
TRANSLATION_NOTE: Русский оригинал (авторитетный источник). Английский документ SIGN_CORE_CARD_ROMAN_CAPITAL_L_U216C_GEN3_v0_3_EN — зеркало. Кодовые точки, имена полей и формулы идентичны. Гомоглиф: базовый закон — ВЫГЛЯДИТ_ОДИНАКОВО ≠ ЯВЛЯЕТСЯ_ТЕМ_ЖЕ. ЧЕРНОВИК для нашей работы (Vakhter); конвейер — отдельный проект.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_ROMAN_CAPITAL_L_U216C_GEN3_v0_3_RU
CODEPOINT: U+216C
VISIBLE_FORM: Ⅼ
...
DISPLAY_NAME: римская цифра «Ⅼ» пятьдесят (гомоглиф латинской заглавной L)
...
SIGN_CATEGORY:
  - римская цифро-буквоформа «римская пятьдесят» (означает 50 как самостоятельную цифру; символ блока Number Forms)
  - гомоглиф латинской заглавной «L» (U+004C)
  - потенциальный носитель гомоглифного спуфинга при вставке ВНУТРЬ латинского слова

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_CAP_L — римская Ⅼ (U+216C) НЕ есть латинская L (U+004C); другая кодовая точка И это цифра (значение 50), а не буква
  2. NOT_SAME_STRING_AS_LATIN — строка с римской Ⅼ не машинно-равна своему латинскому двойнику
  3. NOT_BRAND_NAME_PROOF — «ⅬEGO» не доказывает связь с брендом Lego
...
NOTE: римская «Ⅼ» пятьдесят — стабильная цифро-форма без культурной прецессии функций. «Гомоглиф» — не эпоха, а свойство визуального совпадения с латинской L, сосуществующее с легитимной цифровой функцией формы. Опасность контекстна (вставка внутрь латинского слова), а не эпохальна — поэтому SEMANTIC_EPOCH_TRACKER не применяется.
LAYER_ANOMALY:
...
SAFE_CASES:
  SAFE_CASE_001:
    INPUT: "Ⅼ years" (50 лет, римская цифра)
  ...
  SAFE_CASE_003:
    INPUT: "Volume Ⅼ" (том 50, римская цифра)
    CONTEXT: самостоятельный токен римской цифры рядом с латинским словом
    EXPECTED: INFO
    RISK: NONE
    GUARD: ROMAN_CAP_L_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_004:
    INPUT: "Chapter Ⅼ" (глава 50, римская цифра)
    CONTEXT: самостоятельный токен римской цифры рядом с латинским словом
    EXPECTED: INFO
    RISK: NONE
    GUARD: ROMAN_CAP_L_FORM ≠ EFFECT
  SAFE_CASE_005:
    ...
    GUARD: ROMAN_CAP_L_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_006:
    INPUT: "Super Bowl Ⅼ" (Супербоул 50, римская цифра)
...
RISK_CASES:
  RISK_CASE_001:
    ...
    INPUT: "ⅬEGO-shop.com"
    CONTEXT: IDN/бренд-спуф — токен выглядит как LEGO, но первый символ — римская цифра
    RISK: CRITICAL
  ...
  RISK_CASE_002:
    ...
    INPUT: "ⅬG-electronics-deal.com"
    CONTEXT: ведущая подмена в капслок-названии бренда
    RISK: CRITICAL
    ATTACK: строка машинно-≠ LG, но человек не видит разницы
  ...
  RISK_CASE_003:
    ...
    RISK: HIGH
    ATTACK: похожий хэндл выглядит как LinkedInHelp, но это другой аккаунт
  ...
  RISK_CASE_006:
    ...
    INPUT: "ⅬOREAⅬ"
    CONTEXT: две римские Ⅼ вокруг латинских букв, имитирующие LOREAL (Ⅼ римская, OREA латиница — цифра-в-слове)
    RISK: HIGH
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_CAP_L ≠ ROMAN_CAP_L (главная цель имперсонации; визуально идентична во многих шрифтах)
  CONFUSABLE_002:
    VISIBLE_FORM: Ｌ
    CODEPOINT: U+FF2C
    NAME: FULLWIDTH LATIN CAPITAL LETTER L
    RISK: MEDIUM
    RULE: FULLWIDTH_CAP_L ≠ ROMAN_CAP_L (полноширинная латинская L; другая форма совместимости)
  CONFUSABLE_003:
    VISIBLE_FORM: 𝗟
    CODEPOINT: U+1D5DF
    NAME: MATHEMATICAL SANS-SERIF BOLD CAPITAL L
    RISK: MEDIUM
    RULE: MATH_SANS_CAP_L ≠ ROMAN_CAP_L (математически-стилизованная латинская L для обхода простых фильтров)
  CONFUSABLE_004:
    VISIBLE_FORM: 𝕃
    CODEPOINT: U+1D543
    NAME: MATHEMATICAL DOUBLE-STRUCK CAPITAL L
    RISK: MEDIUM
    RULE: DOUBLE_STRUCK_L ≠ ROMAN_CAP_L (двуштриховая латинская L)
  CONFUSABLE_005:
    VISIBLE_FORM: 𝐋
    CODEPOINT: U+1D40B
    NAME: MATHEMATICAL BOLD CAPITAL L
    RISK: LOW
    RULE: MATH_BOLD_CAP_L ≠ ROMAN_CAP_L (жирная латинская L)
  CONFUSABLE_006:
    VISIBLE_FORM: 𝐿
    CODEPOINT: U+1D43F
    NAME: MATHEMATICAL ITALIC CAPITAL L
    RISK: LOW
    RULE: MATH_ITALIC_CAP_L ≠ ROMAN_CAP_L (курсивная латинская L)

CONTRADICTION_GUARDS:
  CG1:
    TRIGGER: «бренд `ⅬEGO` — это Lego»
    RESPONSE: ROMAN_CAP_L_FORM ≠ LATIN_CAP_L
    RULE: первый символ — римская цифра (50); регистрируемый домен/имя другой — решает DNS, а не глаз
  CG2:
  ...
  CG5:
    TRIGGER: «хэндл `@ⅬinkedInHelp` — тот же аккаунт, что и @LinkedInHelp»
...
SEQUENCE_LAYER_BOUNDARY:
  ...
  SEQUENCE_CANDIDATES:
    SC1:
      SEQUENCE: "ⅬEGO" (римская Ⅼ + латиница в одном токене)
    ...
    SC2:
      SEQUENCE: "ⅬOREAⅬ" (две римские Ⅼ среди латинских заглавных)
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: замена латинской L (U+004C) на римскую Ⅼ (U+216C) в домене бренда
  A2: смешение римской Ⅼ с двуштриховой 𝕃 / математической sans-serif L для усложнения детекции
...
CATEGORY_C: SEQUENCE_MANIPULATION (2)
  C1: токен-цифра-в-слове `ⅬEGO` (SC1) — римская форма внутри одного слова
  C2: множественная подмена `ⅬOREAⅬ` (SC2) на целевой бренд
CATEGORY_D: SEMANTIC_MIMICRY (2)
  D1: хэндл `@ⅬinkedInHelp` имитирует бренд-аккаунт
  D2: "ⅬLOYDS-secure" — двойник в псевдо-официальном имени
CATEGORY_E: PHAGO_ENTITY_MIMICRY (2)
  E1: `ⅬEGO-shop.com` — имитация имени бренда (PE_001)
  E2: `@ⅬinkedInHelp` — имитация официального аккаунта (PE_002)
...
============================================================
MUTATION_01:
  CLAIM: `ⅬEGO-shop.com` с римской Ⅼ — это домен Lego
...
MUTATION_04:
  ...
  RESULT: FAIL
MUTATION_05:
  CLAIM: хэндл `@ⅬinkedInHelp` — тот же аккаунт, что и `@LinkedInHelp`
