...
DOCUMENT_ID: SIGN_CORE_CARD_CYRILLIC_CAPITAL_IE_U0415_GEN3_v0_3_EN
...
TRANSLATION_NOTE: English mirror of SIGN_CORE_CARD_CYRILLIC_CAPITAL_IE_U0415_GEN3_v0_3_RU (authoritative). Codepoints, field names and formulas identical. Homoglyph sign: core law is LOOKS_SAME ≠ IS_SAME. DRAFT for our work (Vakhter); conveyor is a separate project.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_CYRILLIC_CAPITAL_IE_U0415_GEN3_v0_3_EN
CODEPOINT: U+0415
VISIBLE_FORM: Е
...
DISPLAY_NAME: Cyrillic "Е" (homoglyph of Latin capital E)
...
SIGN_CATEGORY:
  - Cyrillic capital letter Ie (sounds /je/; legitimate in Russian / other Cyrillic scripts)
  - homoglyph of Latin capital "E" (U+0045)
  - potential carrier of homoglyph / IDN spoofing when scripts are mixed

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_CAP_E — Cyrillic Е (U+0415) is NOT Latin E (U+0045); a different codepoint
  2. NOT_SAME_STRING_AS_LATIN — a string with Cyrillic Е is not machine-equal to its Latin twin
  3. NOT_BRAND_NAME_PROOF — "ЕBAY" does not prove a link to the eBay brand
...
SAFE_CASES:
  SAFE_CASE_001:
    INPUT: "Екатерина Великая" (Catherine the Great)
    CONTEXT: ordinary Russian text (single script)
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAP_IE_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_002:
    INPUT: "Европа и Азия" (Europe and Asia)
    CONTEXT: Russian sentence where "Е" is an ordinary capital
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAP_IE_FORM ≠ EFFECT
  SAFE_CASE_003:
    INPUT: "Екатеринбург" (Yekaterinburg)
    CONTEXT: Russian place name
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAP_IE_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_004:
    INPUT: "Единая система" (a unified system)
    CONTEXT: single-script Cyrillic phrase
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAP_IE_FORM ≠ EFFECT
  SAFE_CASE_005:
    INPUT: "Ежегодная встреча" (an annual meeting)
    CONTEXT: Russian words beginning with "Е"
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAP_IE_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_006:
    INPUT: "Елена и Евгений" (Elena and Evgeniy)
    CONTEXT: two names beginning with "Е", all Cyrillic
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAP_IE_FORM ≠ AUTOMATICALLY_SPOOF
...
RISK_CASES:
  RISK_CASE_001:
    ...
    INPUT: "ЕBAY-login.com" (Cyrillic Е at the start of a brand)
    CONTEXT: IDN/brand spoof — the token looks like EBAY but the first char is Cyrillic
    RISK: CRITICAL
    ATTACK: replacing Latin E with Cyrillic Е yields a visually identical brand the attacker registers
    GUARD: CYRILLIC_CAP_IE_FORM ≠ LATIN_CAP_E
  RISK_CASE_002:
    NAME: ALLCAPS_BRAND_SUBSTITUTION
    INPUT: "ЕSPN-live.com" (Cyrillic Е in an all-caps brand)
  ...
  RISK_CASE_003:
    ...
    INPUT: "@ЕtsySupport" (Cyrillic Е in a handle)
  ...
  RISK_CASE_004:
    ...
    INPUT: "ЕRROR" (Cyrillic Е bypasses an "ERROR" blocklist)
  ...
  RISK_CASE_005:
    ...
    INPUT: "no-reply@Еxpedia-deals.example" (Cyrillic Е in the mail domain)
  ...
  RISK_CASE_006:
    ...
    INPUT: "ЕNTЕR" (several Cyrillic Е imitating a Latin word)
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_CAP_E ≠ CYRILLIC_CAP_IE (the primary impersonation target; visually identical in many fonts)
  CONFUSABLE_002:
    VISIBLE_FORM: Ε
    CODEPOINT: U+0395
    NAME: GREEK CAPITAL LETTER EPSILON
    RISK: HIGH
    RULE: GREEK_CAP_EPSILON ≠ CYRILLIC_CAP_IE (a third script with the same E-shape; complicates detection)
  CONFUSABLE_003:
    VISIBLE_FORM: 𝗘
    CODEPOINT: U+1D5D8
    NAME: MATHEMATICAL SANS-SERIF BOLD CAPITAL E
    RISK: MEDIUM
    RULE: MATH_SANS_CAP_E ≠ CYRILLIC_CAP_IE (a math-alphanumeric styled Latin E used to dodge simple filters)
  CONFUSABLE_004:
    VISIBLE_FORM: Ｅ
    CODEPOINT: U+FF25
    NAME: FULLWIDTH LATIN CAPITAL LETTER E
    RISK: MEDIUM
    RULE: FULLWIDTH_CAP_E ≠ CYRILLIC_CAP_IE (a full-width Latin E; a different compatibility form)
  CONFUSABLE_005:
    VISIBLE_FORM: Ё
    CODEPOINT: U+0401
    NAME: CYRILLIC CAPITAL LETTER IO
    RISK: LOW
    RULE: CYRILLIC_CAP_IO ≠ CYRILLIC_CAP_IE (the two-dot Cyrillic sibling; a distinct letter, not this sign)
  CONFUSABLE_006:
    VISIBLE_FORM: Ɛ
    CODEPOINT: U+0190
    NAME: LATIN CAPITAL LETTER OPEN E
    RISK: LOW
    RULE: LATIN_CAP_OPEN_E ≠ CYRILLIC_CAP_IE (an epsilon-like Latin letter)

CONTRADICTION_GUARDS:
  CG1:
    TRIGGER: "the brand `ЕBAY` is eBay"
    RESPONSE: CYRILLIC_CAP_IE_FORM ≠ LATIN_CAP_E
    RULE: the first char is Cyrillic Ie; the registrable domain/name is different — DNS decides, not the eye
  CG2:
  ...
  CG5:
    TRIGGER: "the handle `@ЕtsySupport` is the same account as @EtsySupport"
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: substitution of Latin E (U+0045) with Cyrillic Е (U+0415) in a brand domain
  A2: mixing Cyrillic Е with Greek Epsilon Ε / math sans-serif E to complicate detection
CATEGORY_B: CONTEXT_INJECTION (2)
  B1: Cyrillic Е bypasses a Latin-keyword blocklist (ЕRROR)
  B2: Cyrillic Е in a mail domain (no-reply@Еxpedia-deals.example) for phishing
CATEGORY_C: SEQUENCE_MANIPULATION (2)
  C1: the mixed token `ЕBAY` (SC1) — scripts within one word
  C2: multiple substitution `ЕNTЕR` (SC2) onto a target word
CATEGORY_D: SEMANTIC_MIMICRY (2)
  D1: the handle `@ЕtsySupport` imitates a brand account
  D2: "Еxpedia-deals" — a look-alike in a pseudo-official name
CATEGORY_E: PHAGO_ENTITY_MIMICRY (2)
  E1: `ЕBAY-login.com` — mimicry of a brand name (PE_001)
  E2: `@ЕtsySupport` — mimicry of an official account (PE_002)
...
============================================================
MUTATION_01:
  CLAIM: `ЕBAY-login.com` with Cyrillic Е is eBay's domain
...
MUTATION_03:
  ...
  RESULT: FAIL
MUTATION_04:
  CLAIM: an ASCII filter on "ERROR" will catch "ЕRROR"
  EXPECTED: FAIL_ASCII_COVERAGE_MIMICRY
  RESULT: FAIL
MUTATION_05:
  CLAIM: the handle `@ЕtsySupport` is the same account as `@EtsySupport`
