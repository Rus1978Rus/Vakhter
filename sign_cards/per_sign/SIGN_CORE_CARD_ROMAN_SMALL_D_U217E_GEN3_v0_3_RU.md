...
DOCUMENT_ID: SIGN_CORE_CARD_ROMAN_SMALL_D_U217E_GEN3_v0_3_RU
...
TRANSLATION_NOTE: Русский оригинал (авторитетный источник). Английский документ SIGN_CORE_CARD_ROMAN_SMALL_D_U217E_GEN3_v0_3_EN — зеркало. Кодовые точки, имена полей и формулы идентичны. Гомоглиф: базовый закон — ВЫГЛЯДИТ_ОДИНАКОВО ≠ ЯВЛЯЕТСЯ_ТЕМ_ЖЕ. ЧЕРНОВИК для нашей работы (Vakhter); конвейер — отдельный проект.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_ROMAN_SMALL_D_U217E_GEN3_v0_3_RU
CODEPOINT: U+217E
VISIBLE_FORM: ⅾ
...
DISPLAY_NAME: римская цифра «ⅾ» малая пятьсот (гомоглиф латинской строчной d)
...
SIGN_CATEGORY:
  - римская цифро-буквоформа «малая римская пятьсот» (означает 500 как самостоятельную цифру; символ блока Number Forms)
  - гомоглиф латинской строчной «d» (U+0064)
  - потенциальный носитель гомоглифного спуфинга при вставке ВНУТРЬ латинского слова

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_D — римская ⅾ (U+217E) НЕ есть латинская d (U+0064); другая кодовая точка И это цифра (значение 500), а не буква
  2. NOT_SAME_STRING_AS_LATIN — строка с римской ⅾ не машинно-равна своему латинскому двойнику
  3. NOT_BRAND_NAME_PROOF — «ⅾropbox» не доказывает связь с брендом Dropbox
...
NOTE: римская «ⅾ» малая пятьсот — стабильная цифро-форма без культурной прецессии функций. «Гомоглиф» — не эпоха, а свойство визуального совпадения с латинской d, сосуществующее с легитимной цифровой функцией формы. Опасность контекстна (вставка внутрь латинского слова), а не эпохальна — поэтому SEMANTIC_EPOCH_TRACKER не применяется.
LAYER_ANOMALY:
...
SAFE_CASES:
  ...
  SAFE_CASE_005:
    ...
    GUARD: ROMAN_SMALL_D_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_006:
    INPUT: "ⅾⅼ pages" (550 страниц, римская цифра)
    CONTEXT: цельный токен из римских цифр
    EXPECTED: INFO
    RISK: NONE
    GUARD: ROMAN_SMALL_D_FORM ≠ AUTOMATICALLY_SPOOF
...
RISK_CASES:
  RISK_CASE_001:
    ...
    CONTEXT: IDN/бренд-спуф — токен выглядит как dropbox, но первый символ — римская цифра
    RISK: CRITICAL
  ...
  RISK_CASE_005:
    ...
    INPUT: "no-reply@ⅾhl-secure.example"
  ...
  RISK_CASE_006:
    ...
    INPUT: "ⅾoorⅾash"
    CONTEXT: две римские ⅾ среди латинских букв, имитирующие doordash (ⅾ римская, oor/ash латиница — цифра-в-слове)
    RISK: HIGH
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_D ≠ ROMAN_SMALL_D (главная цель имперсонации; визуально идентична во многих шрифтах)
  CONFUSABLE_002:
    VISIBLE_FORM: ⅆ
    CODEPOINT: U+2146
    NAME: DOUBLE-STRUCK ITALIC SMALL D
    RISK: MEDIUM
    RULE: DOUBLE_STRUCK_D ≠ ROMAN_SMALL_D (буквоподобная математическая d для обхода простых фильтров)
  CONFUSABLE_003:
    VISIBLE_FORM: ｄ
    CODEPOINT: U+FF44
    NAME: FULLWIDTH LATIN SMALL LETTER D
    RISK: MEDIUM
    RULE: FULLWIDTH_SMALL_D ≠ ROMAN_SMALL_D (полноширинная латинская d; другая форма совместимости)
  CONFUSABLE_004:
    VISIBLE_FORM: 𝖽
    CODEPOINT: U+1D5BD
    NAME: MATHEMATICAL SANS-SERIF SMALL D
    RISK: MEDIUM
    RULE: MATH_SANS_SMALL_D ≠ ROMAN_SMALL_D (математически-стилизованная латинская d)
  CONFUSABLE_005:
    VISIBLE_FORM: 𝐝
    CODEPOINT: U+1D41D
    NAME: MATHEMATICAL BOLD SMALL D
    RISK: LOW
    RULE: MATH_BOLD_SMALL_D ≠ ROMAN_SMALL_D (жирная латинская d)
  CONFUSABLE_006:
    VISIBLE_FORM: 𝑑
    CODEPOINT: U+1D451
    NAME: MATHEMATICAL ITALIC SMALL D
    RISK: LOW
    RULE: MATH_ITALIC_SMALL_D ≠ ROMAN_SMALL_D (курсивная латинская d)

CONTRADICTION_GUARDS:
  CG1:
    TRIGGER: «бренд `ⅾropbox` — это Dropbox»
  ...
  CG5:
    TRIGGER: «хэндл `@ⅾiscordHelp` — тот же аккаунт, что и @discordHelp»
...
SEQUENCE_LAYER_BOUNDARY:
  ...
  SEQUENCE_CANDIDATES:
    SC1:
      SEQUENCE: "ⅾropbox" (римская ⅾ + латиница в одном токене)
    ...
    SC2:
      SEQUENCE: "ⅾoorⅾash" (две римские ⅾ среди латинских букв)
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: замена латинской d (U+0064) на римскую ⅾ (U+217E) в домене бренда
  A2: смешение римской ⅾ с двуштриховой ⅆ / математической sans-serif d для усложнения детекции
CATEGORY_B: CONTEXT_INJECTION (2)
  B1: римская ⅾ обходит латинский блок-лист ключевых слов (ⅾownload)
  B2: римская ⅾ в почтовом домене (no-reply@ⅾhl-secure.example) для фишинга
CATEGORY_C: SEQUENCE_MANIPULATION (2)
  C1: токен-цифра-в-слове `ⅾropbox` (SC1) — римская форма внутри одного слова
  C2: множественная подмена `ⅾoorⅾash` (SC2) на целевой бренд
CATEGORY_D: SEMANTIC_MIMICRY (2)
  D1: хэндл `@ⅾiscordHelp` имитирует бренд-аккаунт
  D2: "ⅾhl-secure" — двойник в псевдо-официальном имени
CATEGORY_E: PHAGO_ENTITY_MIMICRY (2)
  E1: `ⅾropbox-login.com` — имитация имени бренда (PE_001)
  E2: `@ⅾiscordHelp` — имитация официального аккаунта (PE_002)
...
============================================================
MUTATION_01:
  CLAIM: `ⅾropbox-login.com` с римской ⅾ — это домен Dropbox
...
MUTATION_03:
  ...
  RESULT: FAIL
MUTATION_04:
  CLAIM: ASCII-фильтр на "download" поймает "ⅾownload"
  EXPECTED: FAIL_ASCII_COVERAGE_MIMICRY
  RESULT: FAIL
MUTATION_05:
  CLAIM: хэндл `@ⅾiscordHelp` — тот же аккаунт, что и `@discordHelp`
