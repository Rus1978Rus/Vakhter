...
DOCUMENT_ID: SIGN_CORE_CARD_CYRILLIC_CAPITAL_ES_U0421_GEN3_v0_3_EN
...
TRANSLATION_NOTE: English mirror of SIGN_CORE_CARD_CYRILLIC_CAPITAL_ES_U0421_GEN3_v0_3_RU (authoritative). Codepoints, field names and formulas identical. Homoglyph sign: core law is LOOKS_SAME ≠ IS_SAME. DRAFT for our work (Vakhter); conveyor is a separate project.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_CYRILLIC_CAPITAL_ES_U0421_GEN3_v0_3_EN
CODEPOINT: U+0421
VISIBLE_FORM: С
...
DISPLAY_NAME: Cyrillic "С" (homoglyph of Latin capital C; reads /s/)
...
SIGN_CATEGORY:
  - Cyrillic capital letter Es (sounds /s/, NOT /k/; legitimate in Russian / other Cyrillic scripts)
  - homoglyph of Latin capital "C" (U+0043)
  - potential carrier of homoglyph / IDN spoofing when scripts are mixed

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_CAP_C — Cyrillic С (U+0421) is NOT Latin C (U+0043); a different codepoint AND a different sound (/s/ not /k/)
  2. NOT_SAME_STRING_AS_LATIN — a string with Cyrillic С is not machine-equal to its Latin twin
  3. NOT_BRAND_NAME_PROOF — "СoinBase" does not prove a link to the Coinbase brand
  ...
  12. NOT_INTERCHANGEABLE_IN_IDENTIFIERS — in an identifier/domain, C→С changes the entity
...
NOTE: Cyrillic "С" is a stable letter with no cultural precession of functions. The C-shape / S-sound mismatch is a permanent trait, not an epoch — the letter reads /s/ in Cyrillic while looking like Latin C. The danger is contextual (mixed scripts), not epochal — so SEMANTIC_EPOCH_TRACKER does not apply.
LAYER_ANOMALY:
...
SAFE_CASES:
  SAFE_CASE_001:
    INPUT: "Санкт-Петербург" (Saint Petersburg)
  ...
  SAFE_CASE_003:
    INPUT: "Самара и Саратов" (Samara and Saratov)
    CONTEXT: Russian place names
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAP_ES_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_004:
    INPUT: "Свет и тень" (light and shadow)
    CONTEXT: single-script Cyrillic phrase
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAP_ES_FORM ≠ EFFECT
  SAFE_CASE_005:
    INPUT: "Северный полюс" (the North Pole)
    CONTEXT: Russian words beginning with "С"
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAP_ES_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_006:
    INPUT: "Светлана и Сергей" (Svetlana and Sergey)
    CONTEXT: two names beginning with "С", all Cyrillic
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAP_ES_FORM ≠ AUTOMATICALLY_SPOOF
...
RISK_CASES:
  RISK_CASE_001:
    ...
    INPUT: "СoinBase-login.com" (Cyrillic С at the start of a brand)
    CONTEXT: IDN/brand spoof — the token looks like CoinBase but the first char is Cyrillic
    RISK: CRITICAL
    ATTACK: replacing Latin C with Cyrillic С yields a visually identical brand the attacker registers
    GUARD: CYRILLIC_CAP_ES_FORM ≠ LATIN_CAP_C
  RISK_CASE_002:
    NAME: ALLCAPS_BRAND_SUBSTITUTION
    INPUT: "СHASE-bank-alert.com" (Cyrillic С in an all-caps brand)
    CONTEXT: leading substitution in an all-caps brand phrase
    RISK: CRITICAL
    ATTACK: the string is machine-≠ CHASE, but a human sees no difference
    GUARD: CYRILLIC_CAP_ES_FORM ≠ DOMAIN_VALIDITY_PROOF
  RISK_CASE_003:
    NAME: HANDLE_IMPERSONATION
    INPUT: "@СhaseSupport" (Cyrillic С in a handle)
  ...
  RISK_CASE_004:
    ...
    INPUT: "СLICK" (Cyrillic С bypasses a "CLICK" blocklist)
  ...
  RISK_CASE_005:
    ...
    INPUT: "no-reply@Сitibank-secure.example" (Cyrillic С in the mail domain)
  ...
  RISK_CASE_006:
    ...
    INPUT: "СBС" (several Cyrillic С imitating a Latin acronym)
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_CAP_C ≠ CYRILLIC_CAP_ES (the primary impersonation target; visually identical in many fonts)
  CONFUSABLE_002:
    VISIBLE_FORM: Ϲ
    CODEPOINT: U+03F9
    NAME: GREEK CAPITAL LUNATE SIGMA SYMBOL
    RISK: HIGH
    RULE: GREEK_LUNATE_SIGMA ≠ CYRILLIC_CAP_ES (a Greek C-shaped symbol; complicates detection)
  CONFUSABLE_003:
    VISIBLE_FORM: 𝗖
    CODEPOINT: U+1D5D6
    NAME: MATHEMATICAL SANS-SERIF BOLD CAPITAL C
    RISK: MEDIUM
    RULE: MATH_SANS_CAP_C ≠ CYRILLIC_CAP_ES (a math-alphanumeric styled Latin C used to dodge simple filters)
  CONFUSABLE_004:
    VISIBLE_FORM: Ｃ
    CODEPOINT: U+FF23
    NAME: FULLWIDTH LATIN CAPITAL LETTER C
    RISK: MEDIUM
    RULE: FULLWIDTH_CAP_C ≠ CYRILLIC_CAP_ES (a full-width Latin C; a different compatibility form)
  CONFUSABLE_005:
    VISIBLE_FORM: Ⲥ
    CODEPOINT: U+2CA4
    NAME: COPTIC CAPITAL LETTER SIMA
    RISK: LOW
    RULE: COPTIC_SIMA ≠ CYRILLIC_CAP_ES (a Coptic letter with the same C-shape)
  CONFUSABLE_006:
    VISIBLE_FORM: Ꮯ
    CODEPOINT: U+13DF
    NAME: CHEROKEE LETTER TLI
    RISK: LOW
    RULE: CHEROKEE_TLI ≠ CYRILLIC_CAP_ES (a Cherokee letter with a C-like shape)

CONTRADICTION_GUARDS:
  CG1:
    TRIGGER: "the brand `СoinBase` is Coinbase"
    RESPONSE: CYRILLIC_CAP_ES_FORM ≠ LATIN_CAP_C
    RULE: the first char is Cyrillic Es (/s/); the registrable domain/name is different — DNS decides, not the eye
  CG2:
  ...
  CG4:
    ...
    RULE: Cyrillic С is outside ASCII; a Latin filter will not match it
  CG5:
    TRIGGER: "the handle `@СhaseSupport` is the same account as @ChaseSupport"
...
PHAGO_ENTITY_MIMICRY:
  PE_001:
    ...
    RISK: CRITICAL
    NOTE: Cyrillic С mimics the NAME itself of a verified brand (not merely structure) — direct mimicry of an entity's existence. This is why the registry flags the sign PHAGO ●; commercial lookalike defenses often miss this class.
  PE_002:
    INPUT: "@СhaseSupport"
    TYPE: PHAGO_ENTITY_MIMICRY
    RISK: HIGH
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: substitution of Latin C (U+0043) with Cyrillic С (U+0421) in a brand domain
  A2: mixing Cyrillic С with Greek lunate sigma Ϲ / math sans-serif C to complicate detection
CATEGORY_B: CONTEXT_INJECTION (2)
  B1: Cyrillic С bypasses a Latin-keyword blocklist (СLICK)
  B2: Cyrillic С in a mail domain (no-reply@Сitibank-secure.example) for phishing
CATEGORY_C: SEQUENCE_MANIPULATION (2)
  C1: the mixed token `СoinBase` (SC1) — scripts within one word
  C2: multiple substitution `СBС` (SC2) onto a target acronym
CATEGORY_D: SEMANTIC_MIMICRY (2)
  D1: the handle `@СhaseSupport` imitates a bank account
  D2: "Сitibank-secure" — a look-alike in a pseudo-official name
CATEGORY_E: PHAGO_ENTITY_MIMICRY (2)
  E1: `СoinBase-login.com` — mimicry of a brand name (PE_001)
  E2: `@СhaseSupport` — mimicry of an official account (PE_002)
...
============================================================
MUTATION_01:
  CLAIM: `СoinBase-login.com` with Cyrillic С is Coinbase's domain
...
MUTATION_03:
  ...
  RESULT: FAIL
MUTATION_04:
  CLAIM: an ASCII filter on "CLICK" will catch "СLICK"
  EXPECTED: FAIL_ASCII_COVERAGE_MIMICRY
  RESULT: FAIL
MUTATION_05:
  CLAIM: the handle `@СhaseSupport` is the same account as `@ChaseSupport`
