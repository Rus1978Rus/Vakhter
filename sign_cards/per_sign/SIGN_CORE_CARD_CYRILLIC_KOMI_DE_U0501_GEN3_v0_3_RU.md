...
DOCUMENT_ID: SIGN_CORE_CARD_CYRILLIC_KOMI_DE_U0501_GEN3_v0_3_RU
...
TRANSLATION_NOTE: Русский оригинал (авторитетный источник). Английский документ SIGN_CORE_CARD_CYRILLIC_KOMI_DE_U0501_GEN3_v0_3_EN — зеркало. Кодовые точки, имена полей и формулы идентичны. Гомоглиф: базовый закон — ВЫГЛЯДИТ_ОДИНАКОВО ≠ ЯВЛЯЕТСЯ_ТЕМ_ЖЕ. ЧЕРНОВИК для нашей работы (Vakhter); конвейер — отдельный проект.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_CYRILLIC_KOMI_DE_U0501_GEN3_v0_3_RU
CODEPOINT: U+0501
VISIBLE_FORM: ԁ
...
DISPLAY_NAME: кириллическая «ԁ» коми де (гомоглиф латинской строчной d)
...
SIGN_CATEGORY:
  - кириллическая коми де — буква коми (молодцовского) алфавита (звук /d/)
  - гомоглиф латинской строчной «d» (U+0064)
  - потенциальный носитель гомоглиф / IDN-подмены при смешении письменностей

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_SMALL_D — кириллическая ԁ (U+0501) НЕ латинская d (U+0064); другая кодовая точка в алфавите коми (молодцовском; звук /d/)
...
NOTE: кириллическая буква коми де — устойчивая буква без культурной прецессии функций. «Гомоглиф» — не эпоха, а свойство визуального совпадения с латинской d, сосуществующее с законной функцией буквы. Опасность контекстна (смешение письменностей), а не эпохальна — поэтому SEMANTIC_EPOCH_TRACKER не применяется.
LAYER_ANOMALY:
  ABSENT_PHYSICAL_LAYER: YES, level L1 (physical gesture)
  NOTE: буква — письменный знак без жестового предшественника; буква коми де — письменный глиф кириллическая письменности.
...
SAFE_CASES:
  ...
  SAFE_CASE_005:
    ...
    GUARD: CYRILLIC_KOMI_DE_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_006:
    INPUT: "виԁан" (односкриптовая кириллица)
    CONTEXT: односкриптовый родной текст
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_KOMI_DE_FORM ≠ AUTOMATICALLY_SPOOF
...
RISK_CASES:
  ...
  RISK_CASE_002:
    ...
    INPUT: "moԁel" (двойник внутри токена `model`)
    CONTEXT: двойник внутри токена `model`
    RISK: CRITICAL
    ATTACK: строка машинно-≠ model, но человек не видит разницы
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_SMALL_LETTER_D ≠ CYRILLIC_KOMI_DE_FORM (главная цель имитации; визуально идентична во многих шрифтах)
  CONFUSABLE_002:
    VISIBLE_FORM: ｄ
    CODEPOINT: U+FF44
    NAME: FULLWIDTH LATIN SMALL LETTER D
    RISK: MEDIUM
    RULE: FULLWIDTH_LATIN_SMALL_LETTER_D ≠ CYRILLIC_KOMI_DE_FORM (полноширинная латинская форма; иная форма совместимости)
  CONFUSABLE_003:
    VISIBLE_FORM: 𝖽
    CODEPOINT: U+1D5BD
    NAME: MATHEMATICAL SANS-SERIF SMALL D
    RISK: MEDIUM
    RULE: MATHEMATICAL_SANS_SERIF_SMALL_D ≠ CYRILLIC_KOMI_DE_FORM (математически-стилизованная латинская буква для обхода простых фильтров)
  CONFUSABLE_004:
    VISIBLE_FORM: 𝐝
    CODEPOINT: U+1D41D
    NAME: MATHEMATICAL BOLD SMALL D
    RISK: LOW
    RULE: MATHEMATICAL_BOLD_SMALL_D ≠ CYRILLIC_KOMI_DE_FORM (полужирная латинская буква)
  CONFUSABLE_005:
    VISIBLE_FORM: 𝑑
    CODEPOINT: U+1D451
    NAME: MATHEMATICAL ITALIC SMALL D
    RISK: LOW
    RULE: MATHEMATICAL_ITALIC_SMALL_D ≠ CYRILLIC_KOMI_DE_FORM (курсивная латинская буква)
  CONFUSABLE_006:
    VISIBLE_FORM: 𝚍
    CODEPOINT: U+1D68D
    NAME: MATHEMATICAL MONOSPACE SMALL D
    RISK: LOW
    RULE: MATHEMATICAL_MONOSPACE_SMALL_D ≠ CYRILLIC_KOMI_DE_FORM (моноширинная латинская буква)
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: замена латинской d (U+0064) на кириллическая ԁ (U+0501) в бренд-домене
