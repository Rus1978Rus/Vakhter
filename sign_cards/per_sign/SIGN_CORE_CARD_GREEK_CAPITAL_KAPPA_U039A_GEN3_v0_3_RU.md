...
DOCUMENT_ID: SIGN_CORE_CARD_GREEK_CAPITAL_KAPPA_U039A_GEN3_v0_3_RU
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_GREEK_CAPITAL_KAPPA_U039A_GEN3_v0_3_RU
CODEPOINT: U+039A
VISIBLE_FORM: Κ
...
DISPLAY_NAME: греческая «Κ» заглавная каппа (гомоглиф латинской заглавной K)
...
SIGN_CATEGORY:
  - греческая заглавная буква Каппа (звучит /к/; легитимна в греческой письменности)
  - гомоглиф латинской заглавной «K» (U+004B)
  - потенциальный носитель гомоглифного / IDN-спуфинга при смешении письменностей

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_CAP_K — греческая Κ (U+039A) НЕ есть латинская K (U+004B); другая кодовая точка в другой письменности
  2. NOT_SAME_STRING_AS_LATIN — строка с греческой Κ не машинно-равна своему латинскому двойнику
  3. NOT_BRAND_NAME_PROOF — «ΚFC» не доказывает связь с брендом KFC
...
NOTE: греческая «Κ» заглавная каппа — стабильная буква без культурной прецессии функций. «Гомоглиф» — не эпоха, а свойство визуального совпадения с латинской K, сосуществующее с легитимной функцией буквы. Опасность контекстна (смешение письменностей), а не эпохальна — поэтому SEMANTIC_EPOCH_TRACKER не применяется.
LAYER_ANOMALY:
...
SAFE_CASES:
  SAFE_CASE_001:
    INPUT: "Κρήτη και Ρόδος" (Крит и Родос, греческий)
    CONTEXT: обычный греческий текст (один скрипт)
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_CAP_KAPPA_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_002:
    INPUT: "Κωνσταντίνος ο Μέγας" (Константин Великий, греческий)
    CONTEXT: греческое имя, где «Κ» — обычная заглавная
    EXPECTED: INFO
    RISK: NONE
  ...
  SAFE_CASE_003:
    ...
    GUARD: GREEK_CAP_KAPPA_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_004:
    INPUT: "Κύπρος και Ελλάδα" (Кипр и Греция, греческий)
    CONTEXT: односкриптовая греческая фраза
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_CAP_KAPPA_FORM ≠ EFFECT
  SAFE_CASE_005:
    INPUT: "Καλή τύχη" (удачи, греческий)
    CONTEXT: греческие слова на «Κ»
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_CAP_KAPPA_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_006:
    INPUT: "Κατερίνα και Κώστας" (Катерина и Костас, греческий)
...
RISK_CASES:
  RISK_CASE_001:
    ...
    CONTEXT: IDN/бренд-спуф — токен выглядит как KFC, но первый символ греческий
    RISK: CRITICAL
  ...
  RISK_CASE_005:
    ...
    INPUT: "rewards@Κohls-offers.example"
  ...
  RISK_CASE_006:
    ...
    INPUT: "ΚODAΚ"
    CONTEXT: две греческие Κ вокруг латинских букв, имитирующие KODAK (Κ греческая, ODA латиница — смешение письменностей)
    RISK: HIGH
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_CAP_K ≠ GREEK_CAP_KAPPA (главная цель имперсонации; визуально идентична во многих шрифтах)
  CONFUSABLE_002:
    VISIBLE_FORM: К
    CODEPOINT: U+041A
    NAME: CYRILLIC CAPITAL LETTER KA
    RISK: HIGH
    RULE: CYRILLIC_CAP_KA ≠ GREEK_CAP_KAPPA (третий скрипт с той же формой K; усложняет детекцию)
  CONFUSABLE_003:
    VISIBLE_FORM: 𝗞
    CODEPOINT: U+1D5DE
    NAME: MATHEMATICAL SANS-SERIF BOLD CAPITAL K
    RISK: MEDIUM
    RULE: MATH_SANS_CAP_K ≠ GREEK_CAP_KAPPA (математически-стилизованная латинская K для обхода простых фильтров)
  CONFUSABLE_004:
    VISIBLE_FORM: Ｋ
    CODEPOINT: U+FF2B
    NAME: FULLWIDTH LATIN CAPITAL LETTER K
    RISK: MEDIUM
    RULE: FULLWIDTH_CAP_K ≠ GREEK_CAP_KAPPA (полноширинная латинская K; другая форма совместимости)
  CONFUSABLE_005:
    VISIBLE_FORM: Ⲕ
    CODEPOINT: U+2C94
    NAME: COPTIC CAPITAL LETTER KAPA
    RISK: LOW
    RULE: COPTIC_KAPA ≠ GREEK_CAP_KAPPA (коптская буква с той же формой K)
  CONFUSABLE_006:
    VISIBLE_FORM: 𝐊
    CODEPOINT: U+1D40A
    NAME: MATHEMATICAL BOLD CAPITAL K
    RISK: LOW
    RULE: MATH_BOLD_CAP_K ≠ GREEK_CAP_KAPPA (жирная латинская K)

CONTRADICTION_GUARDS:
  CG1:
    TRIGGER: «бренд `ΚFC` — это KFC»
    RESPONSE: GREEK_CAP_KAPPA_FORM ≠ LATIN_CAP_K
    RULE: первый символ — греческая заглавная каппа; регистрируемый домен/имя другой — решает DNS, а не глаз
  CG2:
...
SEQUENCE_LAYER_BOUNDARY:
  ...
  SEQUENCE_CANDIDATES:
    SC1:
      SEQUENCE: "ΚFC" (греческая Κ + латиница в одном токене)
    ...
    SC2:
      SEQUENCE: "ΚODAΚ" (две греческие Κ вокруг латинских заглавных)
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: замена латинской K (U+004B) на греческую Κ (U+039A) в домене бренда
  A2: смешение греческой Κ с кириллической К / математической sans-serif K для усложнения детекции
CATEGORY_B: CONTEXT_INJECTION (2)
  B1: греческая Κ обходит латинский блок-лист ключевых слов (ΚEY)
  B2: греческая Κ в почтовом домене (rewards@Κohls-offers.example) для фишинга
CATEGORY_C: SEQUENCE_MANIPULATION (2)
  C1: смешанный токен `ΚFC` (SC1) — письменности внутри одного слова
  C2: множественная подмена `ΚODAΚ` (SC2) на целевой бренд
CATEGORY_D: SEMANTIC_MIMICRY (2)
  D1: хэндл `@ΚrakenHelp` имитирует бренд-аккаунт
  D2: "Κohls-offers" — двойник в псевдо-официальном имени
CATEGORY_E: PHAGO_ENTITY_MIMICRY (2)
  E1: `ΚFC-coupons.com` — имитация имени бренда (PE_001)
...
============================================================
MUTATION_01:
  CLAIM: `ΚFC-coupons.com` с греческой Κ — это домен KFC
...
MUTATION_03:
  ...
  RESULT: FAIL
MUTATION_04:
  CLAIM: ASCII-фильтр на "KEY" поймает "ΚEY"
