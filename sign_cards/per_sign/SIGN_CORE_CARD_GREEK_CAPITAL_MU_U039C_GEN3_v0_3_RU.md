...
DOCUMENT_ID: SIGN_CORE_CARD_GREEK_CAPITAL_MU_U039C_GEN3_v0_3_RU
...
TRANSLATION_NOTE: Русский оригинал (авторитетный источник). Английский документ SIGN_CORE_CARD_GREEK_CAPITAL_MU_U039C_GEN3_v0_3_EN — зеркало. Кодовые точки, имена полей и формулы идентичны. Гомоглиф: базовый закон — ВЫГЛЯДИТ_ОДИНАКОВО ≠ ЯВЛЯЕТСЯ_ТЕМ_ЖЕ. ЧЕРНОВИК для нашей работы (Vakhter); конвейер — отдельный проект.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_GREEK_CAPITAL_MU_U039C_GEN3_v0_3_RU
CODEPOINT: U+039C
VISIBLE_FORM: Μ
...
DISPLAY_NAME: греческая «Μ» заглавная мю (гомоглиф латинской заглавной M)
...
SIGN_CATEGORY:
  - греческая заглавная буква Мю (звучит /м/; легитимна в греческой письменности)
  - гомоглиф латинской заглавной «M» (U+004D)
  - потенциальный носитель гомоглифного / IDN-спуфинга при смешении письменностей

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_CAP_M — греческая Μ (U+039C) НЕ есть латинская M (U+004D); другая кодовая точка в другой письменности
  2. NOT_SAME_STRING_AS_LATIN — строка с греческой Μ не машинно-равна своему латинскому двойнику
  3. NOT_BRAND_NAME_PROOF — «ΜETA» не доказывает связь с брендом Meta
  ...
  12. NOT_INTERCHANGEABLE_IN_IDENTIFIERS — в идентификаторе/домене замена M→Μ меняет сущность
...
NOTE: греческая «Μ» заглавная мю — стабильная буква без культурной прецессии функций. «Гомоглиф» — не эпоха, а свойство визуального совпадения с латинской M, сосуществующее с легитимной функцией буквы. Опасность контекстна (смешение письменностей), а не эпохальна — поэтому SEMANTIC_EPOCH_TRACKER не применяется.
LAYER_ANOMALY:
...
SAFE_CASES:
  SAFE_CASE_001:
    INPUT: "Μακεδονία και Θράκη" (Македония и Фракия, греческий)
    CONTEXT: обычный греческий текст (один скрипт)
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_CAP_MU_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_002:
    INPUT: "Μέγας Αλέξανδρος" (Александр Великий, греческий)
    CONTEXT: греческая фраза, где «Μ» — обычная заглавная
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_CAP_MU_FORM ≠ EFFECT
  SAFE_CASE_003:
    INPUT: "Μουσική και τέχνη" (музыка и искусство, греческий)
    CONTEXT: односкриптовая греческая фраза
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_CAP_MU_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_004:
    INPUT: "Μαρία και Μιχάλης" (Мария и Михалис, греческий)
    CONTEXT: два греческих имени, один скрипт
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_CAP_MU_FORM ≠ EFFECT
  SAFE_CASE_005:
    INPUT: "Μεγάλη Παρασκευή" (Страстная пятница, греческий)
    CONTEXT: греческая фраза на «Μ»
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_CAP_MU_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_006:
    INPUT: "Μεσόγειος θάλασσα" (Средиземное море, греческий)
    CONTEXT: односкриптовая греческая фраза
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_CAP_MU_FORM ≠ AUTOMATICALLY_SPOOF
...
RISK_CASES:
  RISK_CASE_001:
    ...
    INPUT: "ΜETA-ads.com"
    CONTEXT: IDN/бренд-спуф — токен выглядит как META, но первый символ греческий
    RISK: CRITICAL
    ATTACK: замена латинской M на греческую Μ даёт визуально идентичный бренд, который регистрирует атакующий
    GUARD: GREEK_CAP_MU_FORM ≠ LATIN_CAP_M
  RISK_CASE_002:
    NAME: ALLCAPS_BRAND_SUBSTITUTION
    INPUT: "ΜGM-rewards-deal.com"
  ...
  RISK_CASE_005:
    ...
    INPUT: "billing@Μicrosoft-invoice.example"
  ...
  RISK_CASE_006:
    ...
    INPUT: "ΜGΜ"
    CONTEXT: две греческие Μ вокруг латинской G, имитирующие MGM (Μ греческая, G латиница — смешение письменностей)
    RISK: HIGH
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_CAP_M ≠ GREEK_CAP_MU (главная цель имперсонации; визуально идентична во многих шрифтах)
  CONFUSABLE_002:
    VISIBLE_FORM: М
    CODEPOINT: U+041C
    NAME: CYRILLIC CAPITAL LETTER EM
    RISK: HIGH
    RULE: CYRILLIC_CAP_EM ≠ GREEK_CAP_MU (третий скрипт с той же формой M; усложняет детекцию)
  CONFUSABLE_003:
    VISIBLE_FORM: 𝗠
    CODEPOINT: U+1D5E0
    NAME: MATHEMATICAL SANS-SERIF BOLD CAPITAL M
    RISK: MEDIUM
    RULE: MATH_SANS_CAP_M ≠ GREEK_CAP_MU (математически-стилизованная латинская M для обхода простых фильтров)
  CONFUSABLE_004:
    VISIBLE_FORM: Ｍ
    CODEPOINT: U+FF2D
    NAME: FULLWIDTH LATIN CAPITAL LETTER M
    RISK: MEDIUM
    RULE: FULLWIDTH_CAP_M ≠ GREEK_CAP_MU (полноширинная латинская M; другая форма совместимости)
  CONFUSABLE_005:
    VISIBLE_FORM: Ⲙ
    CODEPOINT: U+2C98
    NAME: COPTIC CAPITAL LETTER MI
    RISK: LOW
    RULE: COPTIC_MI ≠ GREEK_CAP_MU (коптская буква с той же формой M)
  CONFUSABLE_006:
    VISIBLE_FORM: 𝐌
    CODEPOINT: U+1D40C
    NAME: MATHEMATICAL BOLD CAPITAL M
    RISK: LOW
    RULE: MATH_BOLD_CAP_M ≠ GREEK_CAP_MU (жирная латинская M)

CONTRADICTION_GUARDS:
  CG1:
    TRIGGER: «бренд `ΜETA` — это Meta»
    RESPONSE: GREEK_CAP_MU_FORM ≠ LATIN_CAP_M
    RULE: первый символ — греческая заглавная мю; регистрируемый домен/имя другой — решает DNS, а не глаз
  CG2:
    TRIGGER: «строка с греческой Μ равна её латинскому написанию»
    RESPONSE: GREEK_CAP_MU_FORM ≠ SAME_CODEPOINT_AS_LATIN
    RULE: разные кодовые точки → машинно-разные строки
  CG3:
    TRIGGER: «любая греческая Μ в тексте — атака»
  ...
  CG4:
    ...
    RULE: греческая Μ вне ASCII; латинский фильтр её не сматчит
  CG5:
    TRIGGER: «хэндл `@ΜetaMaskHelp` — тот же аккаунт, что и @MetaMaskHelp»
    RESPONSE: GREEK_CAP_MU_FORM ≠ VERIFICATION
    RULE: визуальное сходство не идентифицирует аккаунт
  CG6:
    TRIGGER: «замена M→Μ в идентификаторе безвредна»
...
SEQUENCE_LAYER_BOUNDARY:
  ...
  SEQUENCE_CANDIDATES:
    SC1:
      SEQUENCE: "ΜETA" (греческая Μ + латиница в одном токене)
    ...
    SC2:
      SEQUENCE: "ΜGΜ" (две греческие Μ вокруг латинской заглавной)
...
PHAGO_ENTITY_MIMICRY:
  PE_001:
    ...
    RISK: CRITICAL
    NOTE: греческая Μ имитирует само ИМЯ верифицированного бренда (а не только структуру) — прямая имитация существования сущности. Поэтому реестр помечает знак PHAGO ●; коммерческие защиты от двойников этот класс часто пропускают.
  PE_002:
    INPUT: "@ΜetaMaskHelp"
    TYPE: PHAGO_ENTITY_MIMICRY
    RISK: HIGH
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: замена латинской M (U+004D) на греческую Μ (U+039C) в домене бренда
  A2: смешение греческой Μ с кириллической М / математической sans-serif M для усложнения детекции
CATEGORY_B: CONTEXT_INJECTION (2)
  B1: греческая Μ обходит латинский блок-лист ключевых слов (ΜENU)
  B2: греческая Μ в почтовом домене (billing@Μicrosoft-invoice.example) для фишинга
CATEGORY_C: SEQUENCE_MANIPULATION (2)
  C1: смешанный токен `ΜETA` (SC1) — письменности внутри одного слова
  C2: множественная подмена `ΜGΜ` (SC2) на целевой бренд
CATEGORY_D: SEMANTIC_MIMICRY (2)
  D1: хэндл `@ΜetaMaskHelp` имитирует бренд-аккаунт
  D2: "Μicrosoft-invoice" — двойник в псевдо-официальном имени
CATEGORY_E: PHAGO_ENTITY_MIMICRY (2)
  E1: `ΜETA-ads.com` — имитация имени бренда (PE_001)
  E2: `@ΜetaMaskHelp` — имитация официального аккаунта (PE_002)
...
============================================================
MUTATION_01:
  CLAIM: `ΜETA-ads.com` с греческой Μ — это домен Meta
  EXPECTED: FAIL_BRAND_NAME_MIMICRY
  RESULT: FAIL
MUTATION_02:
  CLAIM: строка с греческой Μ машинно-равна её латинскому написанию
  EXPECTED: FAIL_CODEPOINT_IDENTITY_MIMICRY
  RESULT: FAIL
MUTATION_03:
  CLAIM: любая греческая Μ в тексте — атака
  EXPECTED: FAIL_OVERBLOCK_MIMICRY (обратная ошибка: подлинный греческий — не спуф)
  RESULT: FAIL
MUTATION_04:
  CLAIM: ASCII-фильтр на "MENU" поймает "ΜENU"
  EXPECTED: FAIL_ASCII_COVERAGE_MIMICRY
  RESULT: FAIL
MUTATION_05:
  CLAIM: хэндл `@ΜetaMaskHelp` — тот же аккаунт, что и `@MetaMaskHelp`
  EXPECTED: FAIL_IDENTITY_MIMICRY
  RESULT: FAIL
MUTATION_06:
  CLAIM: замена M→Μ в идентификаторе безвредна
