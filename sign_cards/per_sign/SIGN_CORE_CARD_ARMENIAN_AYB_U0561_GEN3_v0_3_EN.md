...
DOCUMENT_ID: SIGN_CORE_CARD_ARMENIAN_AYB_U0561_GEN3_v0_3_EN
...
TRANSLATION_NOTE: English mirror of SIGN_CORE_CARD_ARMENIAN_AYB_U0561_GEN3_v0_3_RU (authoritative). Codepoints, field names and formulas identical. Homoglyph sign: core law is LOOKS_SAME ≠ IS_SAME. DRAFT for our work (Vakhter); conveyor is a separate project.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_ARMENIAN_AYB_U0561_GEN3_v0_3_EN
CODEPOINT: U+0561
VISIBLE_FORM: ա
...
DISPLAY_NAME: Armenian "ա" ayb (homoglyph of Latin small a)
...
SIGN_CATEGORY:
  - Armenian ayb — the first vowel letter of the Armenian alphabet (sounds /a/)
  - homoglyph of Latin small "a" (U+0061)
  - potential carrier of homoglyph / IDN spoofing when scripts are mixed

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_SMALL_A — Armenian ա (U+0561) is NOT Latin a (U+0061); a different codepoint and the vowel /a/
  ...
  12. NOT_INTERCHANGEABLE_IN_IDENTIFIERS — in an identifier/domain, a→ա changes the entity
...
NOTE: Armenian the letter ayb is a stable letter with no cultural precession of functions. "Homoglyph" is not an epoch but a property of visual coincidence with Latin a, co-existing with the letter's legit function. The danger is contextual (mixed scripts), not epochal — so SEMANTIC_EPOCH_TRACKER does not apply.
LAYER_ANOMALY:
  ABSENT_PHYSICAL_LAYER: YES, level L1 (physical gesture)
  NOTE: a letter is a written sign with no gestural predecessor; the letter ayb is a written glyph of the Armenian script.
...
SAFE_CASES:
  SAFE_CASE_001:
    INPUT: "արեւ" (Armenian (the sun))
    CONTEXT: single-script native text
    EXPECTED: INFO
    RISK: NONE
    GUARD: ARMENIAN_AYB_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_002:
    INPUT: "անուն" (Armenian (a name))
    CONTEXT: single-script native text
    EXPECTED: INFO
    RISK: NONE
    GUARD: ARMENIAN_AYB_FORM ≠ EFFECT
  SAFE_CASE_003:
    INPUT: "ազատ" (Armenian (free))
    CONTEXT: single-script native text
    EXPECTED: INFO
    RISK: NONE
    GUARD: ARMENIAN_AYB_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_004:
    INPUT: "ամպ" (Armenian (a cloud))
    CONTEXT: single-script native text
    EXPECTED: INFO
    RISK: NONE
    GUARD: ARMENIAN_AYB_FORM ≠ EFFECT
  SAFE_CASE_005:
    INPUT: "առյուծ" (Armenian (a lion))
    CONTEXT: single-script native text
    EXPECTED: INFO
    RISK: NONE
    GUARD: ARMENIAN_AYB_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_006:
    INPUT: "ախպեր" (Armenian (brother))
    CONTEXT: single-script native text
    EXPECTED: INFO
    RISK: NONE
    GUARD: ARMENIAN_AYB_FORM ≠ AUTOMATICALLY_SPOOF
...
RISK_CASES:
  RISK_CASE_001:
    ...
    INPUT: "աmazon-login.com" (IDN/brand spoof — the token looks like amazon but a letter is Armenian)
    CONTEXT: IDN/brand spoof — the token looks like amazon but a letter is Armenian
    RISK: CRITICAL
    ATTACK: replacing Latin a with Armenian ա yields a visually identical brand the attacker registers
    GUARD: ARMENIAN_AYB_FORM ≠ LATIN_SMALL_A
  RISK_CASE_002:
    NAME: BRAND_DOMAIN_SUBSTITUTION
    INPUT: "աpple" (a look-alike inside the token `apple`)
    CONTEXT: a look-alike inside the token `apple`
    RISK: CRITICAL
    ATTACK: the string is machine-≠ apple, but a human sees no difference
    GUARD: ARMENIAN_AYB_FORM ≠ DOMAIN_VALIDITY_PROOF
  RISK_CASE_003:
    NAME: HANDLE_IMPERSONATION
    INPUT: "@աmazonSupport" (impersonating a brand account in a chat/social platform)
    CONTEXT: impersonating a brand account in a chat/social platform
    RISK: HIGH
    ATTACK: the look-alike handle appears as amazonSupport but is a different account
    GUARD: ARMENIAN_AYB_FORM ≠ VERIFICATION
  RISK_CASE_004:
    NAME: FILTER_BYPASS_KEYWORD
    INPUT: "աccount" (bypassing a text filter looking for the Latin word `account`)
  ...
  RISK_CASE_005:
    ...
    INPUT: "billing@աdobe-secure.example" (a phishing email from the "same" company)
  ...
  RISK_CASE_006:
    ...
    INPUT: "աlibaba-billing.com" (another target brand (alibaba) opened with the look-alike)
    CONTEXT: another target brand (alibaba) opened with the look-alike
    RISK: HIGH
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_SMALL_LETTER_A ≠ ARMENIAN_AYB_FORM (the primary impersonation target; visually identical in many fonts)
  CONFUSABLE_002:
    VISIBLE_FORM: ａ
    CODEPOINT: U+FF41
    NAME: FULLWIDTH LATIN SMALL LETTER A
    RISK: MEDIUM
    RULE: FULLWIDTH_LATIN_SMALL_LETTER_A ≠ ARMENIAN_AYB_FORM (a full-width Latin form; a different compatibility form)
  CONFUSABLE_003:
    VISIBLE_FORM: 𝖺
    CODEPOINT: U+1D5BA
    NAME: MATHEMATICAL SANS-SERIF SMALL A
    RISK: MEDIUM
    RULE: MATHEMATICAL_SANS_SERIF_SMALL_A ≠ ARMENIAN_AYB_FORM (a math-alphanumeric styled Latin letter used to dodge simple filters)
  CONFUSABLE_004:
    VISIBLE_FORM: 𝐚
    CODEPOINT: U+1D41A
    NAME: MATHEMATICAL BOLD SMALL A
    RISK: LOW
    RULE: MATHEMATICAL_BOLD_SMALL_A ≠ ARMENIAN_AYB_FORM (a bold-styled Latin letter)
  CONFUSABLE_005:
    VISIBLE_FORM: 𝑎
    CODEPOINT: U+1D44E
    NAME: MATHEMATICAL ITALIC SMALL A
    RISK: LOW
    RULE: MATHEMATICAL_ITALIC_SMALL_A ≠ ARMENIAN_AYB_FORM (an italic-styled Latin letter)
  CONFUSABLE_006:
    VISIBLE_FORM: 𝚊
    CODEPOINT: U+1D68A
    NAME: MATHEMATICAL MONOSPACE SMALL A
    RISK: LOW
    RULE: MATHEMATICAL_MONOSPACE_SMALL_A ≠ ARMENIAN_AYB_FORM (a monospace-styled Latin letter)

CONTRADICTION_GUARDS:
  CG1:
    TRIGGER: "the brand `աmazon` is Amazon"
    RESPONSE: ARMENIAN_AYB_FORM ≠ LATIN_SMALL_A
    RULE: the letter is Armenian ա (and the vowel /a/); the registrable domain/name is different — DNS decides, not the eye
  CG2:
  ...
  CG5:
    TRIGGER: "the handle `@աmazonSupport` is the same account as the Latin one"
    RESPONSE: ARMENIAN_AYB_FORM ≠ VERIFICATION
    RULE: visual similarity does not identify an account
  CG6:
    TRIGGER: "swapping a→ա in an identifier is harmless"
...
SEQUENCE_LAYER_BOUNDARY:
  ...
  SEQUENCE_CANDIDATES:
    SC1:
      SEQUENCE: "աmazon-login.com" (Armenian ա + Latin in one token)
      NAME: MIXED_SCRIPT_TOKEN
      RISK_LEVEL: CRITICAL
      POSSIBLE_CONTEXTS: IDN/brand spoof; the key signal is a SCRIPT MIX within one token
      REQUIRES_SEQUENCE_INTEGRATOR: YES
    SC2:
      SEQUENCE: "աlibaba-billing.com" (capital-initial look-alike on a target brand)
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: substitution of Latin a (U+0061) with Armenian ա (U+0561) in a brand domain
  A2: mixing ա with math/full-width Latin a to complicate detection
CATEGORY_B: CONTEXT_INJECTION (2)
  B1: ա bypasses a Latin-keyword blocklist (աccount)
  B2: ա in a mail domain (billing@աdobe-secure.example) for phishing
CATEGORY_C: SEQUENCE_MANIPULATION (2)
  C1: the mixed token `աmazon-login.com` (SC1) — scripts within one word
  C2: opening/multiple substitution `աlibaba-billing.com` (SC2) onto a target brand
CATEGORY_D: SEMANTIC_MIMICRY (2)
  D1: the handle `@աmazonSupport` imitates a brand account
  D2: `billing@աdobe-secure.example` — a look-alike in a pseudo-official name
CATEGORY_E: PHAGO_ENTITY_MIMICRY (2)
  E1: `աmazon-login.com` — mimicry of a brand name (PE_001)
  E2: `@աmazonSupport` — mimicry of an official account (PE_002)
...
============================================================
MUTATION_01:
  CLAIM: `աmazon-login.com` with ա is the real brand's domain
...
MUTATION_03:
  ...
  RESULT: FAIL
MUTATION_04:
  CLAIM: an ASCII filter on the Latin word will catch `աccount`
  EXPECTED: FAIL_ASCII_COVERAGE_MIMICRY
  RESULT: FAIL
MUTATION_05:
  CLAIM: the handle `@աmazonSupport` is the same account as the Latin one
  EXPECTED: FAIL_IDENTITY_MIMICRY
  RESULT: FAIL
MUTATION_06:
  CLAIM: swapping a→ա in an identifier is harmless
