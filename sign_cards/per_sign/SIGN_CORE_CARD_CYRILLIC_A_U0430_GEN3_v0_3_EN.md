...
DOCUMENT_ID: SIGN_CORE_CARD_CYRILLIC_A_U0430_GEN3_v0_3_EN
...
TRANSLATION_NOTE: English mirror of SIGN_CORE_CARD_CYRILLIC_A_U0430_GEN3_v0_3_RU (authoritative). Codepoints, field names and formulas identical. Homoglyph sign: core law is LOOKS_SAME ≠ IS_SAME. DRAFT for our work (Vakhter); conveyor is a separate project.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_CYRILLIC_A_U0430_GEN3_v0_3_EN
CODEPOINT: U+0430
VISIBLE_FORM: а
...
DISPLAY_NAME: Cyrillic "а" (homoglyph of Latin a)
...
WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_A — Cyrillic а (U+0430) is NOT Latin a (U+0061); a different codepoint
  2. NOT_SAME_STRING_AS_LATIN — a string with Cyrillic а is not machine-equal to its Latin twin
  3. NOT_BRAND_NAME_PROOF — "аpple" does not prove a link to the Apple brand
...
SAFE_CASES:
  SAFE_CASE_001:
    INPUT: "привет мир" (hello world, Russian)
    CONTEXT: ordinary Russian text (single script)
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_A_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_002:
    INPUT: "Анна Ахматова" (a Russian name)
    CONTEXT: Russian proper name
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_A_FORM ≠ EFFECT
  SAFE_CASE_003:
    INPUT: "касса магазина" (the shop till)
    CONTEXT: Russian words where "а" is an ordinary letter
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_A_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_004:
    INPUT: "1 апреля 2026" (1 April 2026)
    CONTEXT: date with a Russian month
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_A_FORM ≠ EFFECT
  SAFE_CASE_005:
    INPUT: "банк России" (Bank of Russia)
  ...
  SAFE_CASE_006:
    INPUT: "мама" (mum)
    CONTEXT: a word made only of potentially-confusable letters, yet all Cyrillic
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_A_FORM ≠ AUTOMATICALLY_SPOOF
...
RISK_CASES:
  RISK_CASE_001:
    ...
    INPUT: "аpple.com" (Cyrillic а + Latin pple)
    CONTEXT: IDN/brand spoof — the token looks like apple.com but the first char is Cyrillic
    RISK: CRITICAL
    ATTACK: replacing Latin a with Cyrillic а yields a visually identical domain the attacker registers
    GUARD: CYRILLIC_A_FORM ≠ LATIN_A
  RISK_CASE_002:
    NAME: PAYPAL_HOMOGLYPH
    INPUT: "pаypal.com" (Cyrillic а in the middle)
    CONTEXT: medial substitution in a brand
    RISK: CRITICAL
    ATTACK: the string is machine-≠ paypal.com, but a human sees no difference
    GUARD: CYRILLIC_A_FORM ≠ DOMAIN_VALIDITY_PROOF
  RISK_CASE_003:
    NAME: HANDLE_IMPERSONATION
    INPUT: "@аdmin" (Cyrillic а in a handle)
  ...
  RISK_CASE_004:
    ...
    INPUT: "cаsino" (Cyrillic а bypasses a "casino" blocklist)
  ...
  RISK_CASE_005:
    ...
    INPUT: "support@bаnk.example" (Cyrillic а in the mail domain)
  ...
  RISK_CASE_006:
    ...
    INPUT: "раyраl" (several Cyrillic а/р imitating paypal)
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_A ≠ CYRILLIC_A (the primary impersonation target; visually identical in many fonts)
  CONFUSABLE_002:
    VISIBLE_FORM: α
    CODEPOINT: U+03B1
    NAME: GREEK SMALL LETTER ALPHA
    RISK: MEDIUM
    RULE: GREEK_ALPHA ≠ CYRILLIC_A (similar in some fonts)
  CONFUSABLE_003:
    VISIBLE_FORM: ɑ
    CODEPOINT: U+0251
  ...
  CONFUSABLE_005:
    ...
    RISK: LOW
    RULE: LATIN_A_ACUTE ≠ CYRILLIC_A (accented Latin twin)
  CONFUSABLE_006:
    VISIBLE_FORM: ạ
    CODEPOINT: U+1EA1
...
CONTRADICTION_GUARDS:
  CG1:
    TRIGGER: "the domain `аpple.com` is Apple"
  ...
  CG5:
    TRIGGER: "the handle `@аdmin` is the same account as @admin"
...
SEQUENCE_LAYER_BOUNDARY:
  ...
  SEQUENCE_CANDIDATES:
    SC1:
      SEQUENCE: "аpple" (Cyrillic а + Latin in one token)
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: substitution of Latin a (U+0061) with Cyrillic а (U+0430) in a brand domain
  A2: mixing Cyrillic а with Greek α / Latin ɑ to complicate detection
CATEGORY_B: CONTEXT_INJECTION (2)
  B1: Cyrillic а bypasses a Latin-keyword blocklist (cаsino)
  B2: Cyrillic а in a mail domain (support@bаnk.example) for phishing
CATEGORY_C: SEQUENCE_MANIPULATION (2)
  C1: the mixed token `аpple` (SC1) — scripts within one word
  C2: multiple substitution `раyраl` (SC2) onto a target brand
CATEGORY_D: SEMANTIC_MIMICRY (2)
  D1: the handle `@аdmin` imitates a service account
  D2: "cаfe-official" — a look-alike in a pseudo-official name
CATEGORY_E: PHAGO_ENTITY_MIMICRY (2)
  E1: `аpple.com` — mimicry of a brand name (PE_001)
  E2: `@аmazon_support` — mimicry of an official account (PE_002)
...
============================================================
MUTATION_01:
  CLAIM: `аpple.com` with Cyrillic а is Apple's domain
...
MUTATION_03:
  ...
  RESULT: FAIL
MUTATION_04:
  CLAIM: an ASCII filter on "casino" will catch "cаsino"
  EXPECTED: FAIL_ASCII_COVERAGE_MIMICRY
  RESULT: FAIL
MUTATION_05:
  CLAIM: the handle `@аdmin` is the same account as `@admin`
