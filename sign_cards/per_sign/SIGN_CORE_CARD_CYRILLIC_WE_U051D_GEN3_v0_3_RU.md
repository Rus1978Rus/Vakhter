...
DOCUMENT_ID: SIGN_CORE_CARD_CYRILLIC_WE_U051D_GEN3_v0_3_RU
...
TRANSLATION_NOTE: Русский оригинал (авторитетный источник). Английский документ SIGN_CORE_CARD_CYRILLIC_WE_U051D_GEN3_v0_3_EN — зеркало. Кодовые точки, имена полей и формулы идентичны. Гомоглиф: базовый закон — ВЫГЛЯДИТ_ОДИНАКОВО ≠ ЯВЛЯЕТСЯ_ТЕМ_ЖЕ. ЧЕРНОВИК для нашей работы (Vakhter); конвейер — отдельный проект.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_CYRILLIC_WE_U051D_GEN3_v0_3_RU
CODEPOINT: U+051D
VISIBLE_FORM: ԝ
...
DISPLAY_NAME: кириллическая «ԝ» ве We (гомоглиф латинской строчной w)
...
SIGN_CATEGORY:
  - кириллическая ве (We) — буква курдской кириллицы (звук /w/)
  - гомоглиф латинской строчной «w» (U+0077)
  - потенциальный носитель гомоглиф / IDN-подмены при смешении письменностей

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_SMALL_W — кириллическая ԝ (U+051D) НЕ латинская w (U+0077); другая кодовая точка в курдской кириллице (звук /w/)
...
NOTE: кириллическая буква ве (We) — устойчивая буква без культурной прецессии функций. «Гомоглиф» — не эпоха, а свойство визуального совпадения с латинской w, сосуществующее с законной функцией буквы. Опасность контекстна (смешение письменностей), а не эпохальна — поэтому SEMANTIC_EPOCH_TRACKER не применяется.
LAYER_ANOMALY:
  ABSENT_PHYSICAL_LAYER: YES, level L1 (physical gesture)
  NOTE: буква — письменный знак без жестового предшественника; буква ве (We) — письменный глиф кириллическая письменности.
...
SAFE_CASES:
  SAFE_CASE_001:
    INPUT: "ԝара" (односкриптовая кириллица (курдский))
    CONTEXT: односкриптовый родной текст
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_WE_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_002:
    INPUT: "сԝан" (односкриптовая кириллица)
    CONTEXT: односкриптовый родной текст
    EXPECTED: INFO
    RISK: NONE
  ...
  SAFE_CASE_005:
    ...
    GUARD: CYRILLIC_WE_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_006:
    INPUT: "наԝа" (односкриптовая кириллица)
    CONTEXT: односкриптовый родной текст
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_WE_FORM ≠ AUTOMATICALLY_SPOOF
...
RISK_CASES:
  ...
  RISK_CASE_002:
    ...
    INPUT: "netԝork" (двойник внутри токена `network`)
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_SMALL_LETTER_W ≠ CYRILLIC_WE_FORM (главная цель имитации; визуально идентична во многих шрифтах)
  CONFUSABLE_002:
    VISIBLE_FORM: ｗ
    CODEPOINT: U+FF57
    NAME: FULLWIDTH LATIN SMALL LETTER W
    RISK: MEDIUM
    RULE: FULLWIDTH_LATIN_SMALL_LETTER_W ≠ CYRILLIC_WE_FORM (полноширинная латинская форма; иная форма совместимости)
  CONFUSABLE_003:
    VISIBLE_FORM: 𝗐
    CODEPOINT: U+1D5D0
    NAME: MATHEMATICAL SANS-SERIF SMALL W
    RISK: MEDIUM
    RULE: MATHEMATICAL_SANS_SERIF_SMALL_W ≠ CYRILLIC_WE_FORM (математически-стилизованная латинская буква для обхода простых фильтров)
  CONFUSABLE_004:
    VISIBLE_FORM: 𝐰
    CODEPOINT: U+1D430
    NAME: MATHEMATICAL BOLD SMALL W
    RISK: LOW
    RULE: MATHEMATICAL_BOLD_SMALL_W ≠ CYRILLIC_WE_FORM (полужирная латинская буква)
  CONFUSABLE_005:
    VISIBLE_FORM: 𝑤
    CODEPOINT: U+1D464
    NAME: MATHEMATICAL ITALIC SMALL W
    RISK: LOW
    RULE: MATHEMATICAL_ITALIC_SMALL_W ≠ CYRILLIC_WE_FORM (курсивная латинская буква)
  CONFUSABLE_006:
    VISIBLE_FORM: 𝚠
    CODEPOINT: U+1D6A0
    NAME: MATHEMATICAL MONOSPACE SMALL W
    RISK: LOW
    RULE: MATHEMATICAL_MONOSPACE_SMALL_W ≠ CYRILLIC_WE_FORM (моноширинная латинская буква)
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: замена латинской w (U+0077) на кириллическая ԝ (U+051D) в бренд-домене
