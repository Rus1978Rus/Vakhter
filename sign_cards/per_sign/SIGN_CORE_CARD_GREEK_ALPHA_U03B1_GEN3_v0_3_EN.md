...
DOCUMENT_ID: SIGN_CORE_CARD_GREEK_ALPHA_U03B1_GEN3_v0_3_EN
...
TRANSLATION_NOTE: English mirror of SIGN_CORE_CARD_GREEK_ALPHA_U03B1_GEN3_v0_3_RU (authoritative). Codepoints, field names and formulas identical. Homoglyph sign: core law is LOOKS_SAME ≠ IS_SAME. DRAFT for our work (Vakhter); conveyor is a separate project.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_GREEK_ALPHA_U03B1_GEN3_v0_3_EN
CODEPOINT: U+03B1
VISIBLE_FORM: α
...
DISPLAY_NAME: Greek "α" alpha (homoglyph of Latin small a; reads /a/)
...
SIGN_CATEGORY:
  - Greek small letter alpha (sounds /a/; legitimate in Greek script)
  - homoglyph of Latin small "a" (U+0061)
  - potential carrier of homoglyph / IDN spoofing when scripts are mixed

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_SMALL_A — Greek α (U+03B1) is NOT Latin a (U+0061); a different codepoint in a different script
...
NOTE: Greek "α" alpha is a stable letter with no cultural precession of functions. "Homoglyph" is not an epoch but a property of visual coincidence with Latin a (single-story), co-existing with the letter's legit function. The danger is contextual (mixed scripts), not epochal — so SEMANTIC_EPOCH_TRACKER does not apply.
LAYER_ANOMALY:
...
SAFE_CASES:
  SAFE_CASE_001:
    INPUT: "αγάπη και ελπίδα" (love and hope, Greek)
    CONTEXT: ordinary Greek text (single script)
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_ALPHA_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_002:
    INPUT: "άνθρωπος και φύση" (human and nature, Greek)
    CONTEXT: a Greek phrase where "α" is an ordinary letter
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_ALPHA_FORM ≠ EFFECT
  SAFE_CASE_003:
    INPUT: "αλήθεια και δικαιοσύνη" (truth and justice, Greek)
    CONTEXT: single-script Greek phrase
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_ALPHA_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_004:
    INPUT: "θάλασσα και άμμος" (sea and sand, Greek)
    CONTEXT: single-script Greek phrase using "α"
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_ALPHA_FORM ≠ EFFECT
  SAFE_CASE_005:
    INPUT: "άνεμος και βροχή" (wind and rain, Greek)
    CONTEXT: Greek words using "α"
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_ALPHA_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_006:
    INPUT: "αστέρι και φεγγάρι" (star and moon, Greek)
    CONTEXT: single-script Greek phrase
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_ALPHA_FORM ≠ AUTOMATICALLY_SPOOF
...
RISK_CASES:
  ...
  RISK_CASE_002:
    ...
    INPUT: "αdobe-billing.com" (Greek α in a brand)
  ...
  RISK_CASE_003:
    ...
    INPUT: "@αppleCare" (Greek α in a handle)
    CONTEXT: impersonating a brand account in a chat/social platform
    RISK: HIGH
    ATTACK: the look-alike handle appears as appleCare but is a different account
  ...
  RISK_CASE_005:
    ...
    INPUT: "no-reply@αlibaba-secure.example" (Greek α in the mail domain)
  ...
  RISK_CASE_006:
    ...
    INPUT: "αdαm" (two Greek α around Latin letters, imitating adam)
    CONTEXT: multiple substitutions in one token (α Greek, dm Latin — a script mix)
    RISK: HIGH
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_SMALL_A ≠ GREEK_ALPHA (the primary impersonation target; visually similar in single-story fonts)
  CONFUSABLE_002:
    VISIBLE_FORM: а
    CODEPOINT: U+0430
    NAME: CYRILLIC SMALL LETTER A
    RISK: HIGH
    RULE: CYRILLIC_SMALL_A ≠ GREEK_ALPHA (a third script with the same a-shape; complicates detection)
  CONFUSABLE_003:
    VISIBLE_FORM: ａ
    CODEPOINT: U+FF41
    NAME: FULLWIDTH LATIN SMALL LETTER A
    RISK: MEDIUM
    RULE: FULLWIDTH_SMALL_A ≠ GREEK_ALPHA (a full-width Latin a; a different compatibility form)
  CONFUSABLE_004:
    VISIBLE_FORM: 𝑎
    CODEPOINT: U+1D44E
    NAME: MATHEMATICAL ITALIC SMALL A
    RISK: MEDIUM
    RULE: MATH_ITALIC_SMALL_A ≠ GREEK_ALPHA (a math-alphanumeric styled Latin a used to dodge simple filters)
  CONFUSABLE_005:
    VISIBLE_FORM: 𝖺
    CODEPOINT: U+1D5BA
    NAME: MATHEMATICAL SANS-SERIF SMALL A
    RISK: LOW
    RULE: MATH_SANS_SMALL_A ≠ GREEK_ALPHA (a single-story sans-serif Latin a, close to alpha's form)
  CONFUSABLE_006:
    VISIBLE_FORM: ⍺
    CODEPOINT: U+237A
    NAME: APL FUNCTIONAL SYMBOL ALPHA
    RISK: LOW
    RULE: APL_ALPHA ≠ GREEK_ALPHA (an APL symbol with the same alpha shape)

CONTRADICTION_GUARDS:
  CG1:
    TRIGGER: "the brand `αmazon` is Amazon"
    RESPONSE: GREEK_ALPHA_FORM ≠ LATIN_SMALL_A
    RULE: the first char is Greek alpha; the registrable domain/name is different — DNS decides, not the eye
  CG2:
  ...
  CG5:
    TRIGGER: "the handle `@αppleCare` is the same account as @appleCare"
...
SEQUENCE_LAYER_BOUNDARY:
  ...
  SEQUENCE_CANDIDATES:
    ...
    SC2:
      SEQUENCE: "αdαm" (two Greek α around Latin letters)
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: substitution of Latin a (U+0061) with Greek α (U+03B1) in a brand domain
  A2: mixing Greek α with Cyrillic а / math-styled a to complicate detection
CATEGORY_B: CONTEXT_INJECTION (2)
  B1: Greek α bypasses a Latin-keyword blocklist (αdmin)
  B2: Greek α in a mail domain (no-reply@αlibaba-secure.example) for phishing
CATEGORY_C: SEQUENCE_MANIPULATION (2)
  C1: the mixed token `αmazon` (SC1) — scripts within one word
  C2: multiple substitution `αdαm` (SC2) onto a target word
CATEGORY_D: SEMANTIC_MIMICRY (2)
  D1: the handle `@αppleCare` imitates a brand account
  D2: "αlibaba-secure" — a look-alike in a pseudo-official name
CATEGORY_E: PHAGO_ENTITY_MIMICRY (2)
  E1: `αmazon-login.com` — mimicry of a brand name (PE_001)
  E2: `@αppleCare` — mimicry of an official account (PE_002)
...
MUTATION_04:
  ...
  RESULT: FAIL
MUTATION_05:
  CLAIM: the handle `@αppleCare` is the same account as `@appleCare`
