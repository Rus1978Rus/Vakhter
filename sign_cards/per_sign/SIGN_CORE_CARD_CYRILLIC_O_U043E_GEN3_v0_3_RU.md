...
DOCUMENT_ID: SIGN_CORE_CARD_CYRILLIC_O_U043E_GEN3_v0_3_RU
...
TRANSLATION_NOTE: Русский оригинал (авторитетный). Английское зеркало — SIGN_CORE_CARD_CYRILLIC_O_U043E_GEN3_v0_3_EN. Кодпойнты, имена полей и формулы идентичны. Знак-гомоглиф: базовый закон LOOKS_SAME ≠ IS_SAME. ЧЕРНОВИК для нашей работы (Vakhter); конвейер — отдельный проект.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_CYRILLIC_O_U043E_GEN3_v0_3_RU
CODEPOINT: U+043E
VISIBLE_FORM: о
...
DISPLAY_NAME: кириллическая «о» (гомоглиф латинской o)
...
SIGN_CATEGORY:
  ...
  - гомоглиф латинской малой «o» (U+006F)
  - потенциальный носитель гомоглиф / IDN подделки при смешении письменностей

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_O — кириллическая о (U+043E) НЕ есть латинская o (U+006F); другой кодпойнт
  2. NOT_SAME_STRING_AS_LATIN — строка с кириллической о не машинно-равна своему латинскому двойнику
  3. NOT_BRAND_NAME_PROOF — «micrоsoft.com» не доказывает связь с брендом Microsoft
  ...
  7. NOT_ASCII — не в ASCII; фильтры «только ASCII» не видят её как o
  ...
  12. NOT_INTERCHANGEABLE_IN_IDENTIFIERS — в идентификаторе/домене o→о меняет сущность
...
NOTE: кириллическая «о» — стабильная буква без культурной прецессии функций. «Гомоглиф» — не эпоха, а свойство визуального совпадения с латинской o, сосуществующее с легитимной функцией буквы. Опасность контекстна (смешение письменностей), не эпохальна — поэтому SEMANTIC_EPOCH_TRACKER не применяется.
LAYER_ANOMALY:
...
SAFE_CASES:
  ...
  SAFE_CASE_003:
    ...
    CONTEXT: русские слова, где «о» — обычная буква
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_O_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_004:
  ...
  SAFE_CASE_006:
    ...
    CONTEXT: слово, богатое на «о», но всё кириллическое
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_O_FORM ≠ AUTOMATICALLY_SPOOF
...
RISK_CASES:
  RISK_CASE_001:
    ...
    CONTEXT: IDN/бренд-подделка — токен выглядит как microsoft.com, но один символ кириллический
    RISK: CRITICAL
    ATTACK: замена латинской o на кириллическую о даёт визуально идентичный домен, который регистрирует атакующий
  ...
  RISK_CASE_002:
    ...
    RISK: CRITICAL
    ATTACK: строка машинно-≠ openai.com, но человек не видит разницы
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_O ≠ CYRILLIC_O (первичная цель имитации; визуально идентична во многих шрифтах)
  CONFUSABLE_002:
    VISIBLE_FORM: ο
    CODEPOINT: U+03BF
    NAME: GREEK SMALL LETTER OMICRON
    RISK: HIGH
    RULE: GREEK_OMICRON ≠ CYRILLIC_O (третья письменность с той же o-формой; усложняет детекцию)
  CONFUSABLE_003:
    VISIBLE_FORM: 0
    CODEPOINT: U+0030
    NAME: DIGIT ZERO
    RISK: MEDIUM
    RULE: DIGIT_ZERO ≠ CYRILLIC_O (цифра, часто путаемая с o в некоторых шрифтах)
  CONFUSABLE_004:
    VISIBLE_FORM: 𝗈
    CODEPOINT: U+1D5C8
    NAME: MATHEMATICAL SANS-SERIF SMALL O
    RISK: MEDIUM
    RULE: MATH_SANS_O ≠ CYRILLIC_O (математико-алфавитно-стилизованная латинская o для обхода простых фильтров)
  CONFUSABLE_005:
    VISIBLE_FORM: ｏ
    CODEPOINT: U+FF4F
    NAME: FULLWIDTH LATIN SMALL LETTER O
    RISK: LOW
    RULE: FULLWIDTH_O ≠ CYRILLIC_O (полноширинная латинская o; другая совместимостная форма)
  CONFUSABLE_006:
    VISIBLE_FORM: ó
    CODEPOINT: U+00F3
    NAME: LATIN SMALL LETTER O WITH ACUTE
    RISK: LOW
    RULE: LATIN_O_ACUTE ≠ CYRILLIC_O (латинский двойник с диакритикой)
...
CONTRADICTION_GUARDS:
  ...
  CG4:
    ...
    RULE: кириллическая о вне ASCII; латинский фильтр её не совпадёт
  CG5:
...
PHAGO_ENTITY_MIMICRY:
  PE_001:
    ...
    RISK: CRITICAL
    NOTE: кириллическая о имитирует само ИМЯ верифицированного бренда (не просто структуру) — прямая мимикрия существования сущности. Поэтому реестр помечает знак PHAGO ●; коммерческие защиты от двойников часто упускают этот класс.
  PE_002:
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: замена латинской o (U+006F) на кириллическую о (U+043E) в бренд-домене
  A2: смешение кириллической о с греческим омикроном ο / цифрой 0 для усложнения детекции
CATEGORY_B: CONTEXT_INJECTION (2)
  B1: кириллическая о обходит латинский блоклист ключевых слов (prоmo-code)
  B2: кириллическая о в почтовом домене (noreply@lоgin-secure.example) для фишинга
CATEGORY_C: SEQUENCE_MANIPULATION (2)
  C1: смешанный токен `micrоsoft` (SC1) — письменности внутри одного слова
  C2: множественная замена `gооgle` (SC2) на целевой бренд
CATEGORY_D: SEMANTIC_MIMICRY (2)
  D1: хэндл `@suppоrt` имитирует сервисный аккаунт
  D2: "lоgin-official" — двойник в псевдо-официальном имени
CATEGORY_E: PHAGO_ENTITY_MIMICRY (2)
  E1: `micrоsoft.com` — мимикрия имени бренда (PE_001)
  E2: `@оpenai_support` — мимикрия официального аккаунта (PE_002)
