...
DOCUMENT_ID: SIGN_CORE_CARD_ROMAN_CAPITAL_M_U216F_GEN3_v0_3_EN
...
TRANSLATION_NOTE: English mirror of SIGN_CORE_CARD_ROMAN_CAPITAL_M_U216F_GEN3_v0_3_RU (authoritative). Codepoints, field names and formulas identical. Homoglyph sign: core law is LOOKS_SAME ≠ IS_SAME. DRAFT for our work (Vakhter); conveyor is a separate project.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_ROMAN_CAPITAL_M_U216F_GEN3_v0_3_EN
CODEPOINT: U+216F
VISIBLE_FORM: Ⅿ
...
DISPLAY_NAME: Roman numeral "Ⅿ" one thousand (homoglyph of Latin capital M)
...
SIGN_CATEGORY:
  - Roman-numeral letter-form "roman numeral one thousand" (means 1000 as a standalone numeral; a Number Forms character)
  - homoglyph of Latin capital "M" (U+004D)
  - potential carrier of homoglyph spoofing when mixed INTO a Latin word

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_CAP_M — Roman Ⅿ (U+216F) is NOT Latin M (U+004D); a different codepoint AND a numeral (value 1000), not a letter
  2. NOT_SAME_STRING_AS_LATIN — a string with Roman Ⅿ is not machine-equal to its Latin twin
  3. NOT_BRAND_NAME_PROOF — "ⅯETA" does not prove a link to the Meta brand
...
SAFE_CASES:
  ...
  SAFE_CASE_003:
    INPUT: "Volume Ⅿ" (volume 1000, Roman numeral)
...
RISK_CASES:
  RISK_CASE_001:
    ...
    INPUT: "ⅯETA-ads.com" (Roman Ⅿ at the start of a brand)
    CONTEXT: IDN/brand spoof — the token looks like META but the first char is a Roman numeral
    RISK: CRITICAL
  ...
  RISK_CASE_002:
    ...
    INPUT: "ⅯGM-rewards-deal.com" (Roman Ⅿ in an all-caps brand)
  ...
  RISK_CASE_003:
    ...
    INPUT: "@ⅯcAfeeHelp" (Roman Ⅿ in a handle)
    CONTEXT: impersonating a brand account in a chat/social platform
    RISK: HIGH
    ATTACK: the look-alike handle appears as McAfeeHelp but is a different account
    GUARD: ROMAN_CAP_M_FORM ≠ VERIFICATION
  RISK_CASE_004:
    NAME: FILTER_BYPASS_KEYWORD
    INPUT: "ⅯENU" (Roman Ⅿ bypasses a "MENU" blocklist)
  ...
  RISK_CASE_006:
    ...
    CONTEXT: multiple substitutions in one all-caps token (Ⅿ Roman, AXI Latin — a numeral-in-word mix)
    RISK: HIGH
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_CAP_M ≠ ROMAN_CAP_M (the primary impersonation target; visually identical in many fonts)
  CONFUSABLE_002:
    VISIBLE_FORM: М
    CODEPOINT: U+041C
    NAME: CYRILLIC CAPITAL LETTER EM
    RISK: HIGH
    RULE: CYRILLIC_CAP_EM ≠ ROMAN_CAP_M (another script with the same M-shape; complicates detection)
  CONFUSABLE_003:
    VISIBLE_FORM: Ｍ
    CODEPOINT: U+FF2D
    NAME: FULLWIDTH LATIN CAPITAL LETTER M
    RISK: MEDIUM
    RULE: FULLWIDTH_CAP_M ≠ ROMAN_CAP_M (a full-width Latin M; a different compatibility form)
  CONFUSABLE_004:
    VISIBLE_FORM: 𝗠
    CODEPOINT: U+1D5E0
    NAME: MATHEMATICAL SANS-SERIF BOLD CAPITAL M
    RISK: MEDIUM
    RULE: MATH_SANS_CAP_M ≠ ROMAN_CAP_M (a math-alphanumeric styled Latin M used to dodge simple filters)
  CONFUSABLE_005:
    VISIBLE_FORM: 𝐌
    CODEPOINT: U+1D40C
    NAME: MATHEMATICAL BOLD CAPITAL M
    RISK: LOW
    RULE: MATH_BOLD_CAP_M ≠ ROMAN_CAP_M (a bold-styled Latin M)
  CONFUSABLE_006:
    VISIBLE_FORM: 𝑀
    CODEPOINT: U+1D440
    NAME: MATHEMATICAL ITALIC CAPITAL M
    RISK: LOW
    RULE: MATH_ITALIC_CAP_M ≠ ROMAN_CAP_M (an italic-styled Latin M)

CONTRADICTION_GUARDS:
  CG1:
    TRIGGER: "the brand `ⅯETA` is Meta"
  ...
  CG5:
    TRIGGER: "the handle `@ⅯcAfeeHelp` is the same account as @McAfeeHelp"
...
SEQUENCE_LAYER_BOUNDARY:
  ...
  SEQUENCE_CANDIDATES:
    SC1:
      SEQUENCE: "ⅯETA" (Roman Ⅿ + Latin in one token)
    ...
    SC2:
      SEQUENCE: "ⅯAXIⅯ" (two Roman Ⅿ among Latin capitals)
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: substitution of Latin M (U+004D) with Roman Ⅿ (U+216F) in a brand domain
  A2: mixing Roman Ⅿ with Cyrillic Em М / math sans-serif M to complicate detection
CATEGORY_B: CONTEXT_INJECTION (2)
  B1: Roman Ⅿ bypasses a Latin-keyword blocklist (ⅯENU)
  B2: Roman Ⅿ in a mail domain (no-reply@ⅯICROSOFT-secure.example) for phishing
CATEGORY_C: SEQUENCE_MANIPULATION (2)
  C1: the numeral-in-word token `ⅯETA` (SC1) — a Roman form inside one word
  C2: multiple substitution `ⅯAXIⅯ` (SC2) onto a target brand
CATEGORY_D: SEMANTIC_MIMICRY (2)
  D1: the handle `@ⅯcAfeeHelp` imitates a brand account
  D2: "ⅯICROSOFT-secure" — a look-alike in a pseudo-official name
CATEGORY_E: PHAGO_ENTITY_MIMICRY (2)
  E1: `ⅯETA-ads.com` — mimicry of a brand name (PE_001)
  E2: `@ⅯcAfeeHelp` — mimicry of an official account (PE_002)
...
============================================================
MUTATION_01:
  CLAIM: `ⅯETA-ads.com` with Roman Ⅿ is Meta's domain
...
MUTATION_03:
  ...
  RESULT: FAIL
MUTATION_04:
  CLAIM: an ASCII filter on "MENU" will catch "ⅯENU"
  EXPECTED: FAIL_ASCII_COVERAGE_MIMICRY
  RESULT: FAIL
MUTATION_05:
  CLAIM: the handle `@ⅯcAfeeHelp` is the same account as `@McAfeeHelp`
