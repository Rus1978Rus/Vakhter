...
DOCUMENT_ID: SIGN_CORE_CARD_CYRILLIC_IZHITSA_U0475_GEN3_v0_3_RU
...
TRANSLATION_NOTE: Русский оригинал (авторитетный источник). Английский документ SIGN_CORE_CARD_CYRILLIC_IZHITSA_U0475_GEN3_v0_3_EN — зеркало. Кодовые точки, имена полей и формулы идентичны. Гомоглиф: базовый закон — ВЫГЛЯДИТ_ОДИНАКОВО ≠ ЯВЛЯЕТСЯ_ТЕМ_ЖЕ. ЧЕРНОВИК для нашей работы (Vakhter); конвейер — отдельный проект.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_CYRILLIC_IZHITSA_U0475_GEN3_v0_3_RU
CODEPOINT: U+0475
VISIBLE_FORM: ѵ
...
DISPLAY_NAME: кириллическая «ѵ» ижица (гомоглиф латинской строчной v)
...
SIGN_CATEGORY:
  - кириллическая ижица — церковнославянская буква (звук /i/ или /v/)
  - гомоглиф латинской строчной «v» (U+0076)
  - потенциальный носитель гомоглиф / IDN-подмены при смешении письменностей

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_SMALL_V — кириллическая ѵ (U+0475) НЕ латинская v (U+0076); другая кодовая точка в церковнославянском (звук /i/ или /v/)
...
NOTE: кириллическая буква ижица — устойчивая буква без культурной прецессии функций. «Гомоглиф» — не эпоха, а свойство визуального совпадения с латинской v, сосуществующее с законной функцией буквы. Опасность контекстна (смешение письменностей), а не эпохальна — поэтому SEMANTIC_EPOCH_TRACKER не применяется.
LAYER_ANOMALY:
  ABSENT_PHYSICAL_LAYER: YES, level L1 (physical gesture)
  NOTE: буква — письменный знак без жестового предшественника; буква ижица — письменный глиф кириллическая письменности.
...
SAFE_CASES:
  SAFE_CASE_001:
    INPUT: "мѵро" (церковнославянский (миро))
    CONTEXT: односкриптовый родной текст
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_IZHITSA_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_002:
    INPUT: "сѵмволъ" (церковнославянский (символ))
    CONTEXT: односкриптовый родной текст
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_IZHITSA_FORM ≠ EFFECT
  SAFE_CASE_003:
    INPUT: "сѵнодъ" (церковнославянский (синод))
    CONTEXT: односкриптовый родной текст
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_IZHITSA_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_004:
    INPUT: "мѵра" (церковнославянский)
    CONTEXT: односкриптовый родной текст
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_IZHITSA_FORM ≠ EFFECT
  SAFE_CASE_005:
    INPUT: "єѵаггеліе" (церковнославянский (евангелие))
    CONTEXT: односкриптовый родной текст
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_IZHITSA_FORM ≠ AUTOMATICALLY_SPOOF
...
RISK_CASES:
  ...
  RISK_CASE_002:
    ...
    INPUT: "naѵigate" (двойник внутри токена `navigate`)
    CONTEXT: двойник внутри токена `navigate`
    RISK: CRITICAL
    ATTACK: строка машинно-≠ navigate, но человек не видит разницы
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_SMALL_LETTER_V ≠ CYRILLIC_IZHITSA_FORM (главная цель имитации; визуально идентична во многих шрифтах)
  CONFUSABLE_002:
    VISIBLE_FORM: ｖ
    CODEPOINT: U+FF56
    NAME: FULLWIDTH LATIN SMALL LETTER V
    RISK: MEDIUM
    RULE: FULLWIDTH_LATIN_SMALL_LETTER_V ≠ CYRILLIC_IZHITSA_FORM (полноширинная латинская форма; иная форма совместимости)
  CONFUSABLE_003:
    VISIBLE_FORM: 𝗏
    CODEPOINT: U+1D5CF
    NAME: MATHEMATICAL SANS-SERIF SMALL V
    RISK: MEDIUM
    RULE: MATHEMATICAL_SANS_SERIF_SMALL_V ≠ CYRILLIC_IZHITSA_FORM (математически-стилизованная латинская буква для обхода простых фильтров)
  CONFUSABLE_004:
    VISIBLE_FORM: 𝐯
    CODEPOINT: U+1D42F
    NAME: MATHEMATICAL BOLD SMALL V
    RISK: LOW
    RULE: MATHEMATICAL_BOLD_SMALL_V ≠ CYRILLIC_IZHITSA_FORM (полужирная латинская буква)
  CONFUSABLE_005:
    VISIBLE_FORM: 𝑣
    CODEPOINT: U+1D463
    NAME: MATHEMATICAL ITALIC SMALL V
    RISK: LOW
    RULE: MATHEMATICAL_ITALIC_SMALL_V ≠ CYRILLIC_IZHITSA_FORM (курсивная латинская буква)
  CONFUSABLE_006:
    VISIBLE_FORM: 𝚟
    CODEPOINT: U+1D69F
    NAME: MATHEMATICAL MONOSPACE SMALL V
    RISK: LOW
    RULE: MATHEMATICAL_MONOSPACE_SMALL_V ≠ CYRILLIC_IZHITSA_FORM (моноширинная латинская буква)
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: замена латинской v (U+0076) на кириллическая ѵ (U+0475) в бренд-домене
