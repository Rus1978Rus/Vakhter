...
DOCUMENT_ID: SIGN_CORE_CARD_CYRILLIC_QA_U051B_GEN3_v0_3_EN
...
TRANSLATION_NOTE: English mirror of SIGN_CORE_CARD_CYRILLIC_QA_U051B_GEN3_v0_3_RU (authoritative). Codepoints, field names and formulas identical. Homoglyph sign: core law is LOOKS_SAME ≠ IS_SAME. DRAFT for our work (Vakhter); conveyor is a separate project.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_CYRILLIC_QA_U051B_GEN3_v0_3_EN
CODEPOINT: U+051B
VISIBLE_FORM: ԛ
...
DISPLAY_NAME: Cyrillic "ԛ" QA (homoglyph of Latin small q)
...
SIGN_CATEGORY:
  - Cyrillic QA — a letter of Kurdish/Komi extended Cyrillic (sounds /q/)
  - homoglyph of Latin small "q" (U+0071)
  - potential carrier of homoglyph / IDN spoofing when scripts are mixed

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_SMALL_Q — Cyrillic ԛ (U+051B) is NOT Latin q (U+0071); a different codepoint and a uvular /q/ in Kurdish Cyrillic
...
NOTE: Cyrillic the QA letter is a stable letter with no cultural precession of functions. "Homoglyph" is not an epoch but a property of visual coincidence with Latin q, co-existing with the letter's legit function. The danger is contextual (mixed scripts), not epochal — so SEMANTIC_EPOCH_TRACKER does not apply.
LAYER_ANOMALY:
  ABSENT_PHYSICAL_LAYER: YES, level L1 (physical gesture)
  NOTE: a letter is a written sign with no gestural predecessor; the QA letter is a written glyph of the Cyrillic script.
...
SAFE_CASES:
  SAFE_CASE_001:
    INPUT: "ԛандыра" (single-script Cyrillic (Kurdish), QA ordinary)
    CONTEXT: single-script native text
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_QA_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_002:
    INPUT: "мԛан" (single-script Cyrillic)
    CONTEXT: single-script native text
    EXPECTED: INFO
    RISK: NONE
  ...
  SAFE_CASE_004:
    ...
    GUARD: CYRILLIC_QA_FORM ≠ EFFECT
  SAFE_CASE_005:
    INPUT: "сԛан" (single-script Cyrillic)
    CONTEXT: single-script native text
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_QA_FORM ≠ AUTOMATICALLY_SPOOF
...
RISK_CASES:
  ...
  RISK_CASE_002:
    ...
    INPUT: "reԛuest" (a look-alike inside the token `request`)
    CONTEXT: a look-alike inside the token `request`
    RISK: CRITICAL
    ATTACK: the string is machine-≠ request, but a human sees no difference
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_SMALL_LETTER_Q ≠ CYRILLIC_QA_FORM (the primary impersonation target; visually identical in many fonts)
  CONFUSABLE_002:
    VISIBLE_FORM: ｑ
    CODEPOINT: U+FF51
    NAME: FULLWIDTH LATIN SMALL LETTER Q
    RISK: MEDIUM
    RULE: FULLWIDTH_LATIN_SMALL_LETTER_Q ≠ CYRILLIC_QA_FORM (a full-width Latin form; a different compatibility form)
  CONFUSABLE_003:
    VISIBLE_FORM: 𝗊
    CODEPOINT: U+1D5CA
    NAME: MATHEMATICAL SANS-SERIF SMALL Q
    RISK: MEDIUM
    RULE: MATHEMATICAL_SANS_SERIF_SMALL_Q ≠ CYRILLIC_QA_FORM (a math-alphanumeric styled Latin letter used to dodge simple filters)
  CONFUSABLE_004:
    VISIBLE_FORM: 𝐪
    CODEPOINT: U+1D42A
    NAME: MATHEMATICAL BOLD SMALL Q
    RISK: LOW
    RULE: MATHEMATICAL_BOLD_SMALL_Q ≠ CYRILLIC_QA_FORM (a bold-styled Latin letter)
  CONFUSABLE_005:
    VISIBLE_FORM: 𝑞
    CODEPOINT: U+1D45E
    NAME: MATHEMATICAL ITALIC SMALL Q
    RISK: LOW
    RULE: MATHEMATICAL_ITALIC_SMALL_Q ≠ CYRILLIC_QA_FORM (an italic-styled Latin letter)
  CONFUSABLE_006:
    VISIBLE_FORM: 𝚚
    CODEPOINT: U+1D69A
    NAME: MATHEMATICAL MONOSPACE SMALL Q
    RISK: LOW
    RULE: MATHEMATICAL_MONOSPACE_SMALL_Q ≠ CYRILLIC_QA_FORM (a monospace-styled Latin letter)
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: substitution of Latin q (U+0071) with Cyrillic ԛ (U+051B) in a brand domain
