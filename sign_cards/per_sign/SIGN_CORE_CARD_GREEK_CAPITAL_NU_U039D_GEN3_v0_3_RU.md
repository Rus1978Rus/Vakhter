...
DOCUMENT_ID: SIGN_CORE_CARD_GREEK_CAPITAL_NU_U039D_GEN3_v0_3_RU
...
TRANSLATION_NOTE: Русский оригинал (авторитетный источник). Английский документ SIGN_CORE_CARD_GREEK_CAPITAL_NU_U039D_GEN3_v0_3_EN — зеркало. Кодовые точки, имена полей и формулы идентичны. Гомоглиф: базовый закон — ВЫГЛЯДИТ_ОДИНАКОВО ≠ ЯВЛЯЕТСЯ_ТЕМ_ЖЕ. ЧЕРНОВИК для нашей работы (Vakhter); конвейер — отдельный проект.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_GREEK_CAPITAL_NU_U039D_GEN3_v0_3_RU
CODEPOINT: U+039D
VISIBLE_FORM: Ν
...
DISPLAY_NAME: греческая «Ν» заглавная ню (гомоглиф латинской заглавной N)
...
SIGN_CATEGORY:
  - греческая заглавная буква Ню (звучит /н/; легитимна в греческой письменности)
  - гомоглиф латинской заглавной «N» (U+004E)
  - потенциальный носитель гомоглифного / IDN-спуфинга при смешении письменностей

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_CAP_N — греческая Ν (U+039D) НЕ есть латинская N (U+004E); другая кодовая точка в другой письменности
  2. NOT_SAME_STRING_AS_LATIN — строка с греческой Ν не машинно-равна своему латинскому двойнику
  3. NOT_BRAND_NAME_PROOF — «ΝIKE» не доказывает связь с брендом Nike
  ...
  12. NOT_INTERCHANGEABLE_IN_IDENTIFIERS — в идентификаторе/домене замена N→Ν меняет сущность
...
NOTE: греческая «Ν» заглавная ню — стабильная буква без культурной прецессии функций. «Гомоглиф» — не эпоха, а свойство визуального совпадения с латинской N, сосуществующее с легитимной функцией буквы. Опасность контекстна (смешение письменностей), а не эпохальна — поэтому SEMANTIC_EPOCH_TRACKER не применяется.
LAYER_ANOMALY:
...
SAFE_CASES:
  SAFE_CASE_001:
    INPUT: "Ναι και όχι" (да и нет, греческий)
    CONTEXT: обычный греческий текст (один скрипт)
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_CAP_NU_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_002:
    INPUT: "Νίκος και Νατάσα" (Никос и Наташа, греческий)
    CONTEXT: два греческих имени, где «Ν» — обычная заглавная
    EXPECTED: INFO
    RISK: NONE
  ...
  SAFE_CASE_005:
    ...
    CONTEXT: греческие слова на «Ν»
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_CAP_NU_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_006:
    INPUT: "Νύχτα και μέρα" (ночь и день, греческий)
    CONTEXT: односкриптовая греческая фраза
    EXPECTED: INFO
    RISK: NONE
    GUARD: GREEK_CAP_NU_FORM ≠ AUTOMATICALLY_SPOOF
...
RISK_CASES:
  RISK_CASE_001:
    ...
    CONTEXT: IDN/бренд-спуф — токен выглядит как NIKE, но первый символ греческий
    RISK: CRITICAL
    ATTACK: замена латинской N на греческую Ν даёт визуально идентичный бренд, который регистрирует атакующий
    GUARD: GREEK_CAP_NU_FORM ≠ LATIN_CAP_N
  RISK_CASE_002:
    NAME: ALLCAPS_BRAND_SUBSTITUTION
    INPUT: "ΝBC-news-alert.com"
    CONTEXT: ведущая подмена в капслок-названии бренда
    RISK: CRITICAL
    ATTACK: строка машинно-≠ NBC, но человек не видит разницы
  ...
  RISK_CASE_003:
    ...
    RISK: HIGH
    ATTACK: похожий хэндл выглядит как NordVPNhelp, но это другой аккаунт
  ...
  RISK_CASE_005:
    ...
    INPUT: "support@Νetflix-billing.example"
  ...
  RISK_CASE_006:
    ...
    INPUT: "ΝISSAΝ"
    CONTEXT: две греческие Ν вокруг латинских букв, имитирующие NISSAN (Ν греческая, ISSA латиница — смешение письменностей)
    RISK: HIGH
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_CAP_N ≠ GREEK_CAP_NU (главная цель имперсонации; визуально идентична во многих шрифтах)
  CONFUSABLE_002:
    VISIBLE_FORM: Ⲛ
    CODEPOINT: U+2C9A
    NAME: COPTIC CAPITAL LETTER NI
    RISK: HIGH
    RULE: COPTIC_NI ≠ GREEK_CAP_NU (третий скрипт с той же формой N; усложняет детекцию)
  CONFUSABLE_003:
    VISIBLE_FORM: 𝗡
    CODEPOINT: U+1D5E1
    NAME: MATHEMATICAL SANS-SERIF BOLD CAPITAL N
    RISK: MEDIUM
    RULE: MATH_SANS_CAP_N ≠ GREEK_CAP_NU (математически-стилизованная латинская N для обхода простых фильтров)
  CONFUSABLE_004:
    VISIBLE_FORM: Ｎ
    CODEPOINT: U+FF2E
    NAME: FULLWIDTH LATIN CAPITAL LETTER N
    RISK: MEDIUM
    RULE: FULLWIDTH_CAP_N ≠ GREEK_CAP_NU (полноширинная латинская N; другая форма совместимости)
  CONFUSABLE_005:
    VISIBLE_FORM: 𝑁
    CODEPOINT: U+1D441
    NAME: MATHEMATICAL ITALIC CAPITAL N
    RISK: LOW
    RULE: MATH_ITALIC_CAP_N ≠ GREEK_CAP_NU (курсивная латинская N)
  CONFUSABLE_006:
    VISIBLE_FORM: 𝐍
    CODEPOINT: U+1D40D
    NAME: MATHEMATICAL BOLD CAPITAL N
    RISK: LOW
    RULE: MATH_BOLD_CAP_N ≠ GREEK_CAP_NU (жирная латинская N)

CONTRADICTION_GUARDS:
  CG1:
    TRIGGER: «бренд `ΝIKE` — это Nike»
    RESPONSE: GREEK_CAP_NU_FORM ≠ LATIN_CAP_N
    RULE: первый символ — греческая заглавная ню; регистрируемый домен/имя другой — решает DNS, а не глаз
  CG2:
  ...
  CG5:
    TRIGGER: «хэндл `@ΝordVPNhelp` — тот же аккаунт, что и @NordVPNhelp»
    RESPONSE: GREEK_CAP_NU_FORM ≠ VERIFICATION
    RULE: визуальное сходство не идентифицирует аккаунт
  CG6:
    TRIGGER: «замена N→Ν в идентификаторе безвредна»
...
SEQUENCE_LAYER_BOUNDARY:
  ...
  SEQUENCE_CANDIDATES:
    SC1:
      SEQUENCE: "ΝIKE" (греческая Ν + латиница в одном токене)
    ...
    SC2:
      SEQUENCE: "ΝISSAΝ" (две греческие Ν вокруг латинских заглавных)
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: замена латинской N (U+004E) на греческую Ν (U+039D) в домене бренда
  A2: смешение греческой Ν с коптской Ni / математической sans-serif N для усложнения детекции
CATEGORY_B: CONTEXT_INJECTION (2)
  B1: греческая Ν обходит латинский блок-лист ключевых слов (ΝEWS)
  B2: греческая Ν в почтовом домене (support@Νetflix-billing.example) для фишинга
CATEGORY_C: SEQUENCE_MANIPULATION (2)
  C1: смешанный токен `ΝIKE` (SC1) — письменности внутри одного слова
  C2: множественная подмена `ΝISSAΝ` (SC2) на целевой бренд
CATEGORY_D: SEMANTIC_MIMICRY (2)
  D1: хэндл `@ΝordVPNhelp` имитирует бренд-аккаунт
  D2: "Νetflix-billing" — двойник в псевдо-официальном имени
CATEGORY_E: PHAGO_ENTITY_MIMICRY (2)
  E1: `ΝIKE-deals.com` — имитация имени бренда (PE_001)
  E2: `@ΝordVPNhelp` — имитация официального аккаунта (PE_002)
...
============================================================
MUTATION_01:
  CLAIM: `ΝIKE-deals.com` с греческой Ν — это домен Nike
...
MUTATION_03:
  ...
  RESULT: FAIL
MUTATION_04:
  CLAIM: ASCII-фильтр на "NEWS" поймает "ΝEWS"
  EXPECTED: FAIL_ASCII_COVERAGE_MIMICRY
  RESULT: FAIL
MUTATION_05:
  CLAIM: хэндл `@ΝordVPNhelp` — тот же аккаунт, что и `@NordVPNhelp`
  EXPECTED: FAIL_IDENTITY_MIMICRY
  RESULT: FAIL
MUTATION_06:
  CLAIM: замена N→Ν в идентификаторе безвредна
