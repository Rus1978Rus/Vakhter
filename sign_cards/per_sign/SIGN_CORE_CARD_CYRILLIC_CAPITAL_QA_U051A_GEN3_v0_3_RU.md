...
DOCUMENT_ID: SIGN_CORE_CARD_CYRILLIC_CAPITAL_QA_U051A_GEN3_v0_3_RU
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_CYRILLIC_CAPITAL_QA_U051A_GEN3_v0_3_RU
CODEPOINT: U+051A
VISIBLE_FORM: Ԛ
...
DISPLAY_NAME: кириллическая «Ԛ» заглавная ка QA (гомоглиф латинской заглавной Q)
...
SIGN_CATEGORY:
  - кириллическая заглавная ка (QA) — буква расширенной кириллицы (курдский/коми; /q/)
  - гомоглиф латинской заглавной «Q» (U+0051)
  - потенциальный носитель гомоглиф / IDN-подмены при смешении письменностей

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_CAPITAL_Q — кириллическая Ԛ (U+051A) НЕ латинская Q (U+0051); другая кодовая точка и увулярный /q/ в курдской кириллице
...
NOTE: кириллическая заглавная буква ка (QA) — устойчивая буква без культурной прецессии функций. «Гомоглиф» — не эпоха, а свойство визуального совпадения с латинской Q, сосуществующее с законной функцией буквы. Опасность контекстна (смешение письменностей), а не эпохальна — поэтому SEMANTIC_EPOCH_TRACKER не применяется.
LAYER_ANOMALY:
  ABSENT_PHYSICAL_LAYER: YES, level L1 (physical gesture)
  NOTE: буква — письменный знак без жестового предшественника; заглавная буква ка (QA) — письменный глиф кириллическая письменности.
...
SAFE_CASES:
  SAFE_CASE_001:
    INPUT: "Ԛандыра" (односкриптовая кириллица)
  ...
  SAFE_CASE_004:
    ...
    GUARD: CYRILLIC_CAPITAL_QA_FORM ≠ EFFECT
  SAFE_CASE_005:
    INPUT: "Ԛаԛан" (односкриптовая кириллица)
    CONTEXT: односкриптовый родной текст
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAPITAL_QA_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_006:
    INPUT: "Ԛуман" (односкриптовая кириллица)
    CONTEXT: односкриптовый родной текст
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAPITAL_QA_FORM ≠ AUTOMATICALLY_SPOOF
...
RISK_CASES:
  ...
  RISK_CASE_002:
    ...
    INPUT: "Ԛuizlet" (двойник внутри токена `Quizlet`)
    CONTEXT: двойник внутри токена `Quizlet`
    RISK: CRITICAL
    ATTACK: строка машинно-≠ Quizlet, но человек не видит разницы
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_CAPITAL_LETTER_Q ≠ CYRILLIC_CAPITAL_QA_FORM (главная цель имитации; визуально идентична во многих шрифтах)
  CONFUSABLE_002:
    VISIBLE_FORM: Ｑ
    CODEPOINT: U+FF31
    NAME: FULLWIDTH LATIN CAPITAL LETTER Q
    RISK: MEDIUM
    RULE: FULLWIDTH_LATIN_CAPITAL_LETTER_Q ≠ CYRILLIC_CAPITAL_QA_FORM (полноширинная латинская форма; иная форма совместимости)
  CONFUSABLE_003:
    VISIBLE_FORM: 𝖰
    CODEPOINT: U+1D5B0
    NAME: MATHEMATICAL SANS-SERIF CAPITAL Q
    RISK: MEDIUM
    RULE: MATHEMATICAL_SANS_SERIF_CAPITAL_Q ≠ CYRILLIC_CAPITAL_QA_FORM (математически-стилизованная латинская буква для обхода простых фильтров)
  CONFUSABLE_004:
    VISIBLE_FORM: 𝐐
    CODEPOINT: U+1D410
    NAME: MATHEMATICAL BOLD CAPITAL Q
    RISK: LOW
    RULE: MATHEMATICAL_BOLD_CAPITAL_Q ≠ CYRILLIC_CAPITAL_QA_FORM (полужирная латинская буква)
  CONFUSABLE_005:
    VISIBLE_FORM: 𝑄
    CODEPOINT: U+1D444
    NAME: MATHEMATICAL ITALIC CAPITAL Q
    RISK: LOW
    RULE: MATHEMATICAL_ITALIC_CAPITAL_Q ≠ CYRILLIC_CAPITAL_QA_FORM (курсивная латинская буква)
  CONFUSABLE_006:
    VISIBLE_FORM: 𝚀
    CODEPOINT: U+1D680
    NAME: MATHEMATICAL MONOSPACE CAPITAL Q
    RISK: LOW
    RULE: MATHEMATICAL_MONOSPACE_CAPITAL_Q ≠ CYRILLIC_CAPITAL_QA_FORM (моноширинная латинская буква)
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: замена латинской Q (U+0051) на кириллическая Ԛ (U+051A) в бренд-домене
