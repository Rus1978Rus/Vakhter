...
DOCUMENT_ID: SIGN_CORE_CARD_CYRILLIC_DZE_U0455_GEN3_v0_3_EN
...
TRANSLATION_NOTE: English mirror of SIGN_CORE_CARD_CYRILLIC_DZE_U0455_GEN3_v0_3_RU (authoritative). Codepoints, field names and formulas identical. Homoglyph sign: core law is LOOKS_SAME ≠ IS_SAME. DRAFT for our work (Vakhter); conveyor is a separate project.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_CYRILLIC_DZE_U0455_GEN3_v0_3_EN
CODEPOINT: U+0455
VISIBLE_FORM: ѕ
...
DISPLAY_NAME: Cyrillic "ѕ" dze (homoglyph of Latin small s; reads /dz/)
...
SIGN_CATEGORY:
  - Cyrillic small letter Dze (sounds /dz/; legitimate in Macedonian and other Cyrillic scripts)
  - homoglyph of Latin small "s" (U+0073)
  - potential carrier of homoglyph / IDN spoofing when scripts are mixed

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_SMALL_S — Cyrillic ѕ (U+0455) is NOT Latin s (U+0073); a different codepoint AND a different sound (/dz/ not /s/)
...
NOTE: Cyrillic "ѕ" dze is a stable letter with no cultural precession of functions. The s-shape / dz-sound mismatch is a permanent trait, not an epoch — the letter reads /dz/ in Macedonian while looking like Latin s. The danger is contextual (mixed scripts), not epochal — so SEMANTIC_EPOCH_TRACKER does not apply.
LAYER_ANOMALY:
...
SAFE_CASES:
  ...
  SAFE_CASE_002:
    INPUT: "ѕид на куќата" (the wall of the house, Macedonian)
    CONTEXT: Macedonian phrase where "ѕ" is an ordinary letter
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_DZE_FORM ≠ EFFECT
  SAFE_CASE_003:
    INPUT: "ѕвер во шумата" (a beast in the forest, Macedonian)
    CONTEXT: single-script Macedonian phrase
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_DZE_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_004:
    INPUT: "ѕвонче ѕвони" (a little bell rings, Macedonian)
    CONTEXT: Macedonian words using "ѕ"
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_DZE_FORM ≠ EFFECT
  SAFE_CASE_005:
    INPUT: "ѕвездено небо" (a starry sky, Macedonian)
    CONTEXT: single-script Macedonian phrase
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_DZE_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_006:
    INPUT: "ѕвездички" (little stars, Macedonian)
    CONTEXT: a Macedonian word with "ѕ"
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_DZE_FORM ≠ AUTOMATICALLY_SPOOF
...
RISK_CASES:
  RISK_CASE_001:
    ...
    INPUT: "ѕamsung-galaxy.com" (Cyrillic ѕ at the start of a brand)
  ...
  RISK_CASE_002:
    ...
    INPUT: "ѕtripe-payments.com" (Cyrillic ѕ in a brand)
    CONTEXT: leading substitution in a brand phrase
    RISK: CRITICAL
    ATTACK: the string is machine-≠ stripe, but a human sees no difference
  ...
  RISK_CASE_004:
    ...
    INPUT: "ѕudo" (Cyrillic ѕ bypasses a "sudo" blocklist)
  ...
  RISK_CASE_005:
    ...
    INPUT: "no-reply@ѕlack-login.example" (Cyrillic ѕ in the mail domain)
  ...
  RISK_CASE_006:
    ...
    INPUT: "ѕtatuѕ" (two Cyrillic ѕ around Latin letters, imitating status)
    CONTEXT: multiple substitutions in one token (ѕ Cyrillic, tatu Latin — a script mix)
    RISK: HIGH
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_SMALL_S ≠ CYRILLIC_DZE (the primary impersonation target; visually identical in many fonts)
  CONFUSABLE_002:
    VISIBLE_FORM: ｓ
    CODEPOINT: U+FF53
    NAME: FULLWIDTH LATIN SMALL LETTER S
    RISK: MEDIUM
    RULE: FULLWIDTH_SMALL_S ≠ CYRILLIC_DZE (a full-width Latin s; a different compatibility form)
  CONFUSABLE_003:
    VISIBLE_FORM: 𝑠
    CODEPOINT: U+1D460
    NAME: MATHEMATICAL ITALIC SMALL S
    RISK: MEDIUM
    RULE: MATH_ITALIC_SMALL_S ≠ CYRILLIC_DZE (a math-alphanumeric styled Latin s used to dodge simple filters)
  CONFUSABLE_004:
    VISIBLE_FORM: ꜱ
    CODEPOINT: U+A731
    NAME: LATIN LETTER SMALL CAPITAL S
    RISK: LOW
    RULE: LATIN_SMALL_CAPITAL_S ≠ CYRILLIC_DZE (a small-capital Latin s form)
  CONFUSABLE_005:
    VISIBLE_FORM: 𝓈
    CODEPOINT: U+1D4C8
    NAME: MATHEMATICAL SCRIPT SMALL S
    RISK: LOW
    RULE: MATH_SCRIPT_SMALL_S ≠ CYRILLIC_DZE (a script-styled Latin s)
  CONFUSABLE_006:
    VISIBLE_FORM: 𝗌
    CODEPOINT: U+1D5CC
    NAME: MATHEMATICAL SANS-SERIF SMALL S
    RISK: LOW
    RULE: MATH_SANS_SMALL_S ≠ CYRILLIC_DZE (a sans-serif styled Latin s)

CONTRADICTION_GUARDS:
  CG1:
    TRIGGER: "the brand `ѕamsung` is Samsung"
    RESPONSE: CYRILLIC_DZE_FORM ≠ LATIN_SMALL_S
    RULE: the first char is Cyrillic Dze (/dz/); the registrable domain/name is different — DNS decides, not the eye
  CG2:
...
SEQUENCE_LAYER_BOUNDARY:
  ...
  SEQUENCE_CANDIDATES:
    ...
    SC2:
      SEQUENCE: "ѕtatuѕ" (two Cyrillic ѕ around Latin letters)
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: substitution of Latin s (U+0073) with Cyrillic ѕ (U+0455) in a brand domain
  A2: mixing Cyrillic ѕ with a full-width or math-styled Latin s to complicate detection
CATEGORY_B: CONTEXT_INJECTION (2)
  B1: Cyrillic ѕ bypasses a Latin-keyword blocklist (ѕudo)
  B2: Cyrillic ѕ in a mail domain (no-reply@ѕlack-login.example) for phishing
CATEGORY_C: SEQUENCE_MANIPULATION (2)
  C1: the mixed token `ѕamsung` (SC1) — scripts within one word
  C2: multiple substitution `ѕtatuѕ` (SC2) onto a target word
CATEGORY_D: SEMANTIC_MIMICRY (2)
  D1: the handle `@ѕpotifyCare` imitates a brand account
  D2: "ѕlack-login" — a look-alike in a pseudo-official name
CATEGORY_E: PHAGO_ENTITY_MIMICRY (2)
  E1: `ѕamsung-galaxy.com` — mimicry of a brand name (PE_001)
...
============================================================
MUTATION_01:
  CLAIM: `ѕamsung-galaxy.com` with Cyrillic ѕ is Samsung's domain
...
MUTATION_03:
  ...
  RESULT: FAIL
MUTATION_04:
  CLAIM: an ASCII filter on "sudo" will catch "ѕudo"
