...
DOCUMENT_ID: SIGN_CORE_CARD_ROMAN_CAPITAL_C_U216D_GEN3_v0_3_EN
...
TRANSLATION_NOTE: English mirror of SIGN_CORE_CARD_ROMAN_CAPITAL_C_U216D_GEN3_v0_3_RU (authoritative). Codepoints, field names and formulas identical. Homoglyph sign: core law is LOOKS_SAME ≠ IS_SAME. DRAFT for our work (Vakhter); conveyor is a separate project.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_ROMAN_CAPITAL_C_U216D_GEN3_v0_3_EN
CODEPOINT: U+216D
VISIBLE_FORM: Ⅽ
...
DISPLAY_NAME: Roman numeral "Ⅽ" one hundred (homoglyph of Latin capital C)
...
SIGN_CATEGORY:
  - Roman-numeral letter-form "roman numeral one hundred" (means 100 as a standalone numeral; a Number Forms character)
  - homoglyph of Latin capital "C" (U+0043)
  - potential carrier of homoglyph spoofing when mixed INTO a Latin word

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_CAP_C — Roman Ⅽ (U+216D) is NOT Latin C (U+0043); a different codepoint AND a numeral (value 100), not a letter
...
SAFE_CASES:
  ...
  SAFE_CASE_003:
    INPUT: "Volume Ⅽ" (volume 100, Roman numeral)
...
RISK_CASES:
  ...
  RISK_CASE_002:
    ...
    INPUT: "ⅭNN-news-alert.com" (Roman Ⅽ in an all-caps brand)
    CONTEXT: leading substitution in an all-caps brand phrase
    RISK: CRITICAL
    ATTACK: the string is machine-≠ CNN, but a human sees no difference
    GUARD: ROMAN_CAP_C_FORM ≠ DOMAIN_VALIDITY_PROOF
  RISK_CASE_003:
    NAME: HANDLE_IMPERSONATION
    INPUT: "@ⅭhaseSupport" (Roman Ⅽ in a handle)
  ...
  RISK_CASE_004:
    ...
    INPUT: "ⅭMD" (Roman Ⅽ bypasses a "CMD" blocklist)
  ...
  RISK_CASE_005:
    ...
    INPUT: "no-reply@ⅭITIBANK-secure.example" (Roman Ⅽ in the mail domain)
  ...
  RISK_CASE_006:
    ...
    INPUT: "ⅭOSTⅭO" (two Roman Ⅽ around Latin letters, imitating COSTCO)
    CONTEXT: multiple substitutions in one all-caps token (Ⅽ Roman, OST/O Latin — a numeral-in-word mix)
    RISK: HIGH
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_CAP_C ≠ ROMAN_CAP_C (the primary impersonation target; visually identical in many fonts)
  CONFUSABLE_002:
    VISIBLE_FORM: С
    CODEPOINT: U+0421
    NAME: CYRILLIC CAPITAL LETTER ES
    RISK: HIGH
    RULE: CYRILLIC_CAP_ES ≠ ROMAN_CAP_C (another script with the same C-shape; complicates detection)
  CONFUSABLE_003:
    VISIBLE_FORM: Ｃ
    CODEPOINT: U+FF23
    NAME: FULLWIDTH LATIN CAPITAL LETTER C
    RISK: MEDIUM
    RULE: FULLWIDTH_CAP_C ≠ ROMAN_CAP_C (a full-width Latin C; a different compatibility form)
  CONFUSABLE_004:
    VISIBLE_FORM: 𝗖
    CODEPOINT: U+1D5D6
    NAME: MATHEMATICAL SANS-SERIF BOLD CAPITAL C
    RISK: MEDIUM
    RULE: MATH_SANS_CAP_C ≠ ROMAN_CAP_C (a math-alphanumeric styled Latin C used to dodge simple filters)
  CONFUSABLE_005:
    VISIBLE_FORM: 𝐂
    CODEPOINT: U+1D402
    NAME: MATHEMATICAL BOLD CAPITAL C
    RISK: LOW
    RULE: MATH_BOLD_CAP_C ≠ ROMAN_CAP_C (a bold-styled Latin C)
  CONFUSABLE_006:
    VISIBLE_FORM: 𝐶
    CODEPOINT: U+1D436
    NAME: MATHEMATICAL ITALIC CAPITAL C
    RISK: LOW
    RULE: MATH_ITALIC_CAP_C ≠ ROMAN_CAP_C (an italic-styled Latin C)
...
CONTRADICTION_GUARDS:
  ...
  CG5:
    TRIGGER: "the handle `@ⅭhaseSupport` is the same account as @ChaseSupport"
...
SEQUENCE_LAYER_BOUNDARY:
  ...
  SEQUENCE_CANDIDATES:
    ...
    SC2:
      SEQUENCE: "ⅭOSTⅭO" (two Roman Ⅽ among Latin capitals)
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: substitution of Latin C (U+0043) with Roman Ⅽ (U+216D) in a brand domain
  A2: mixing Roman Ⅽ with Cyrillic Es С / math sans-serif C to complicate detection
CATEGORY_B: CONTEXT_INJECTION (2)
  B1: Roman Ⅽ bypasses a Latin-keyword blocklist (ⅭMD)
  B2: Roman Ⅽ in a mail domain (no-reply@ⅭITIBANK-secure.example) for phishing
...
CATEGORY_D: SEMANTIC_MIMICRY (2)
  D1: the handle `@ⅭhaseSupport` imitates a brand account
  D2: "ⅭITIBANK-secure" — a look-alike in a pseudo-official name
CATEGORY_E: PHAGO_ENTITY_MIMICRY (2)
  E1: `ⅭISCO-support.com` — mimicry of a brand name (PE_001)
  E2: `@ⅭhaseSupport` — mimicry of an official account (PE_002)
...
MUTATION_03:
  ...
  RESULT: FAIL
MUTATION_04:
  CLAIM: an ASCII filter on "CMD" will catch "ⅭMD"
  EXPECTED: FAIL_ASCII_COVERAGE_MIMICRY
  RESULT: FAIL
MUTATION_05:
  CLAIM: the handle `@ⅭhaseSupport` is the same account as `@ChaseSupport`
