...
DOCUMENT_ID: SIGN_CORE_CARD_CYRILLIC_I_U0456_GEN3_v0_3_RU
...
TRANSLATION_NOTE: Русский оригинал (авторитетный). Английское зеркало — SIGN_CORE_CARD_CYRILLIC_I_U0456_GEN3_v0_3_EN. Кодпойнты, имена полей и формулы идентичны. Знак-гомоглиф: базовый закон LOOKS_SAME ≠ IS_SAME. ЧЕРНОВИК для нашей работы (Vakhter); конвейер — отдельный проект.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_CYRILLIC_I_U0456_GEN3_v0_3_RU
CODEPOINT: U+0456
VISIBLE_FORM: і
...
DISPLAY_NAME: кириллическая «і» (гомоглиф латинской i)
...
SIGN_CATEGORY:
  - кириллическая буква (легитимна в украинском / белорусском и старых орфографиях)
  - гомоглиф латинской малой «i» (U+0069)
  - потенциальный носитель гомоглиф / IDN подделки при смешении письменностей

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_I — кириллическая і (U+0456) НЕ есть латинская i (U+0069); другой кодпойнт
  2. NOT_SAME_STRING_AS_LATIN — строка с кириллической і не машинно-равна своему латинскому двойнику
  3. NOT_BRAND_NAME_PROOF — «wіkipedia.org» не доказывает связь с брендом Wikipedia
  ...
  7. NOT_ASCII — не в ASCII; фильтры «только ASCII» не видят её как i
  8. NOT_AUTOMATICALLY_SPOOF — в односкриптовом украинском/белорусском тексте она нормальна, не атака
  ...
  12. NOT_INTERCHANGEABLE_IN_IDENTIFIERS — в идентификаторе/домене i→і меняет сущность
...
NOTE: кириллическая «і» — стабильная буква без культурной прецессии функций. «Гомоглиф» — не эпоха, а свойство визуального совпадения с латинской i, сосуществующее с легитимной функцией буквы. Опасность контекстна (смешение письменностей), не эпохальна — поэтому SEMANTIC_EPOCH_TRACKER не применяется.
LAYER_ANOMALY:
...
SAFE_CASES:
  ...
  SAFE_CASE_006:
    ...
    CONTEXT: фраза, богатая на «і», но вся кириллическая
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_I_FORM ≠ AUTOMATICALLY_SPOOF
...
RISK_CASES:
  RISK_CASE_001:
    ...
    CONTEXT: IDN/бренд-подделка — токен выглядит как wikipedia.org, но один символ кириллический
    RISK: CRITICAL
    ATTACK: замена латинской i на кириллическую і даёт визуально идентичный домен, который регистрирует атакующий
    GUARD: CYRILLIC_I_FORM ≠ LATIN_I
  RISK_CASE_002:
    NAME: LEADING_BRAND_SUBSTITUTION
    INPUT: "іnstagram.com" (Cyrillic і at the start of a brand)
    CONTEXT: ведущая замена в бренд-домене
    RISK: CRITICAL
    ATTACK: строка машинно-≠ instagram.com, но человек не видит разницы
    GUARD: CYRILLIC_I_FORM ≠ DOMAIN_VALIDITY_PROOF
  RISK_CASE_003:
    NAME: HANDLE_IMPERSONATION
    INPUT: "@admіn" (Cyrillic і in a handle)
    CONTEXT: выдача себя за аккаунт администратора в чате/соцплатформе
    RISK: HIGH
    ATTACK: похожий хэндл выглядит как admin, но это другой аккаунт
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_I ≠ CYRILLIC_I (первичная цель имитации; визуально идентична во многих шрифтах)
  CONFUSABLE_002:
    VISIBLE_FORM: ı
    CODEPOINT: U+0131
    NAME: LATIN SMALL LETTER DOTLESS I
    RISK: MEDIUM
    RULE: LATIN_DOTLESS_I ≠ CYRILLIC_I (латинская i без точки, используется в турецком; ещё один двойник)
  CONFUSABLE_003:
    VISIBLE_FORM: ι
    CODEPOINT: U+03B9
    NAME: GREEK SMALL LETTER IOTA
    RISK: MEDIUM
    RULE: GREEK_IOTA ≠ CYRILLIC_I (третья письменность с похожей i-формой)
  CONFUSABLE_004:
    VISIBLE_FORM: ј
    CODEPOINT: U+0458
    NAME: CYRILLIC SMALL LETTER JE
    RISK: MEDIUM
    RULE: CYRILLIC_JE ≠ CYRILLIC_I (та же письменность, родственная, но отдельная буква)
  CONFUSABLE_005:
    VISIBLE_FORM: 𝗂
    CODEPOINT: U+1D5C2
    NAME: MATHEMATICAL SANS-SERIF SMALL I
    RISK: LOW
    RULE: MATH_SANS_I ≠ CYRILLIC_I (математико-алфавитно-стилизованная латинская i)
  CONFUSABLE_006:
    VISIBLE_FORM: í
    CODEPOINT: U+00ED
    NAME: LATIN SMALL LETTER I WITH ACUTE
    RISK: LOW
    RULE: LATIN_I_ACUTE ≠ CYRILLIC_I (латинский двойник с диакритикой)

CONTRADICTION_GUARDS:
  CG1:
    TRIGGER: "the domain `wіkipedia.org` is Wikipedia"
    RESPONSE: CYRILLIC_I_FORM ≠ LATIN_I
    RULE: один символ кириллический; регистрируемый домен другой — решает DNS, не глаз
  CG2:
  ...
  CG3:
    ...
    RULE: в односкриптовом украинском/белорусском тексте буква легитимна; подделка — это СМЕШЕНИЕ письменностей в одном токене
  CG4:
    TRIGGER: "an ASCII filter will catch the substituted word"
    RESPONSE: CYRILLIC_I_FORM ≠ ASCII_LETTER
    RULE: кириллическая і вне ASCII; латинский фильтр её не совпадёт
  CG5:
...
PHAGO_ENTITY_MIMICRY:
  PE_001:
    ...
    RISK: CRITICAL
    NOTE: кириллическая і имитирует само ИМЯ верифицированного бренда (не просто структуру) — прямая мимикрия существования сущности. Поэтому реестр помечает знак PHAGO ●; коммерческие защиты от двойников часто упускают этот класс.
  PE_002:
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: замена латинской i (U+0069) на кириллическую і (U+0456) в бренд-домене
  A2: смешение кириллической і с греческой йотой ι / латинской i без точки ı для усложнения детекции
CATEGORY_B: CONTEXT_INJECTION (2)
  B1: кириллическая і обходит латинский блоклист ключевых слов (phіshing)
  B2: кириллическая і в почтовом домене (billing@verіfy-pay.example) для фишинга
CATEGORY_C: SEQUENCE_MANIPULATION (2)
  C1: смешанный токен `wіkipedia` (SC1) — письменности внутри одного слова
  C2: множественная замена `bіtcoіn` (SC2) на целевой бренд
CATEGORY_D: SEMANTIC_MIMICRY (2)
  D1: хэндл `@admіn` имитирует сервисный аккаунт
  D2: "verіfy-official" — двойник в псевдо-официальном имени
CATEGORY_E: PHAGO_ENTITY_MIMICRY (2)
  E1: `wіkipedia.org` — мимикрия имени бренда (PE_001)
  E2: `@іnstagram_help` — мимикрия официального аккаунта (PE_002)
...
MUTATION_03:
  ...
  EXPECTED: FAIL_OVERBLOCK_MIMICRY (обратная ошибка: настоящий украинский — не подделка)
  RESULT: FAIL
MUTATION_04:
...
============================================================
OQ1:
  QUESTION: как отличить легитимный односкриптовый украинский/белорусский текст от подделки без ложных срабатываний?
