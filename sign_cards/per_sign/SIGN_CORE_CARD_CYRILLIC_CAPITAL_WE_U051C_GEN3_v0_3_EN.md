...
DOCUMENT_ID: SIGN_CORE_CARD_CYRILLIC_CAPITAL_WE_U051C_GEN3_v0_3_EN
...
TRANSLATION_NOTE: English mirror of SIGN_CORE_CARD_CYRILLIC_CAPITAL_WE_U051C_GEN3_v0_3_RU (authoritative). Codepoints, field names and formulas identical. Homoglyph sign: core law is LOOKS_SAME ≠ IS_SAME. DRAFT for our work (Vakhter); conveyor is a separate project.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_CYRILLIC_CAPITAL_WE_U051C_GEN3_v0_3_EN
CODEPOINT: U+051C
VISIBLE_FORM: Ԝ
...
DISPLAY_NAME: Cyrillic "Ԝ" capital We (homoglyph of Latin capital W)
...
SIGN_CATEGORY:
  - Cyrillic capital We — a letter of Kurdish Cyrillic (sounds /w/)
  - homoglyph of Latin capital "W" (U+0057)
  - potential carrier of homoglyph / IDN spoofing when scripts are mixed

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_CAPITAL_W — Cyrillic Ԝ (U+051C) is NOT Latin W (U+0057); a different codepoint in Kurdish Cyrillic (sounds /w/)
...
NOTE: Cyrillic the capital We letter is a stable letter with no cultural precession of functions. "Homoglyph" is not an epoch but a property of visual coincidence with Latin W, co-existing with the letter's legit function. The danger is contextual (mixed scripts), not epochal — so SEMANTIC_EPOCH_TRACKER does not apply.
LAYER_ANOMALY:
  ABSENT_PHYSICAL_LAYER: YES, level L1 (physical gesture)
  NOTE: a letter is a written sign with no gestural predecessor; the capital We letter is a written glyph of the Cyrillic script.
...
SAFE_CASES:
  SAFE_CASE_001:
    INPUT: "Ԝара" (single-script Cyrillic)
  ...
  SAFE_CASE_004:
    ...
    GUARD: CYRILLIC_CAPITAL_WE_FORM ≠ EFFECT
  SAFE_CASE_005:
    INPUT: "Ԝана" (single-script Cyrillic)
    CONTEXT: single-script native text
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAPITAL_WE_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_006:
    INPUT: "Ԝуран" (single-script Cyrillic)
    CONTEXT: single-script native text
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAPITAL_WE_FORM ≠ AUTOMATICALLY_SPOOF
...
RISK_CASES:
  ...
  RISK_CASE_002:
    ...
    INPUT: "Ԝise" (a look-alike inside the token `Wise`)
    CONTEXT: a look-alike inside the token `Wise`
    RISK: CRITICAL
    ATTACK: the string is machine-≠ Wise, but a human sees no difference
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_CAPITAL_LETTER_W ≠ CYRILLIC_CAPITAL_WE_FORM (the primary impersonation target; visually identical in many fonts)
  CONFUSABLE_002:
    VISIBLE_FORM: Ｗ
    CODEPOINT: U+FF37
    NAME: FULLWIDTH LATIN CAPITAL LETTER W
    RISK: MEDIUM
    RULE: FULLWIDTH_LATIN_CAPITAL_LETTER_W ≠ CYRILLIC_CAPITAL_WE_FORM (a full-width Latin form; a different compatibility form)
  CONFUSABLE_003:
    VISIBLE_FORM: 𝖶
    CODEPOINT: U+1D5B6
    NAME: MATHEMATICAL SANS-SERIF CAPITAL W
    RISK: MEDIUM
    RULE: MATHEMATICAL_SANS_SERIF_CAPITAL_W ≠ CYRILLIC_CAPITAL_WE_FORM (a math-alphanumeric styled Latin letter used to dodge simple filters)
  CONFUSABLE_004:
    VISIBLE_FORM: 𝐖
    CODEPOINT: U+1D416
    NAME: MATHEMATICAL BOLD CAPITAL W
    RISK: LOW
    RULE: MATHEMATICAL_BOLD_CAPITAL_W ≠ CYRILLIC_CAPITAL_WE_FORM (a bold-styled Latin letter)
  CONFUSABLE_005:
    VISIBLE_FORM: 𝑊
    CODEPOINT: U+1D44A
    NAME: MATHEMATICAL ITALIC CAPITAL W
    RISK: LOW
    RULE: MATHEMATICAL_ITALIC_CAPITAL_W ≠ CYRILLIC_CAPITAL_WE_FORM (an italic-styled Latin letter)
  CONFUSABLE_006:
    VISIBLE_FORM: 𝚆
    CODEPOINT: U+1D686
    NAME: MATHEMATICAL MONOSPACE CAPITAL W
    RISK: LOW
    RULE: MATHEMATICAL_MONOSPACE_CAPITAL_W ≠ CYRILLIC_CAPITAL_WE_FORM (a monospace-styled Latin letter)
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: substitution of Latin W (U+0057) with Cyrillic Ԝ (U+051C) in a brand domain
