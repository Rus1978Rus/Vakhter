...
DOCUMENT_ID: SIGN_CORE_CARD_CYRILLIC_JE_U0458_GEN3_v0_3_EN
...
TRANSLATION_NOTE: English mirror of SIGN_CORE_CARD_CYRILLIC_JE_U0458_GEN3_v0_3_RU (authoritative). Codepoints, field names and formulas identical. Homoglyph sign: core law is LOOKS_SAME ≠ IS_SAME. DRAFT for our work (Vakhter); conveyor is a separate project.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_CYRILLIC_JE_U0458_GEN3_v0_3_EN
CODEPOINT: U+0458
VISIBLE_FORM: ј
...
DISPLAY_NAME: Cyrillic "ј" (homoglyph of Latin j)
...
SIGN_CATEGORY:
  - Cyrillic letter (legitimate in Serbian / Macedonian and other Cyrillic scripts)
  - homoglyph of Latin small "j" (U+006A)
  - potential carrier of homoglyph / IDN spoofing when scripts are mixed

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_J — Cyrillic ј (U+0458) is NOT Latin j (U+006A); a different codepoint
  2. NOT_SAME_STRING_AS_LATIN — a string with Cyrillic ј is not machine-equal to its Latin twin
  3. NOT_BRAND_NAME_PROOF — "јquery.com" does not prove a link to the jQuery project
  ...
  8. NOT_AUTOMATICALLY_SPOOF — in single-script Serbian/Macedonian text it is normal, not an attack
...
NOTE: Cyrillic "ј" is a stable letter with no cultural precession of functions. "Homoglyph" is not an epoch but a property of visual coincidence with Latin j, co-existing with the letter's legit function. The danger is contextual (mixed scripts), not epochal — so SEMANTIC_EPOCH_TRACKER does not apply.
LAYER_ANOMALY:
  ABSENT_PHYSICAL_LAYER: YES, level L1 (physical gesture)
  NOTE: a letter is a written sign with no gestural predecessor; Cyrillic ј was borrowed into Serbian from the Latin j (written genealogy).
...
SAFE_CASES:
  ...
  SAFE_CASE_002:
    ...
    CONTEXT: Serbian proper name
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_JE_FORM ≠ EFFECT
  SAFE_CASE_003:
    INPUT: "српски језик" (the Serbian language)
    CONTEXT: Serbian words where "ј" is an ordinary letter
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_JE_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_004:
    INPUT: "ново јутро" (a new morning)
    CONTEXT: a Serbian phrase
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_JE_FORM ≠ EFFECT
  SAFE_CASE_005:
  ...
  SAFE_CASE_006:
    ...
    CONTEXT: a phrase rich in "ј", yet all Cyrillic
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_JE_FORM ≠ AUTOMATICALLY_SPOOF
...
RISK_CASES:
  RISK_CASE_001:
    ...
    CONTEXT: IDN/brand spoof — the token looks like jquery.com but the first char is Cyrillic
    RISK: CRITICAL
    ATTACK: replacing Latin j with Cyrillic ј yields a visually identical domain the attacker registers
    GUARD: CYRILLIC_JE_FORM ≠ LATIN_J
  RISK_CASE_002:
    NAME: PACKAGE_TYPOSQUAT
    INPUT: "јsonwebtoken" (Cyrillic ј in a package name)
    CONTEXT: a look-alike package name in a registry
    RISK: CRITICAL
    ATTACK: the string is machine-≠ jsonwebtoken, but a human sees no difference
    GUARD: CYRILLIC_JE_FORM ≠ DOMAIN_VALIDITY_PROOF
  RISK_CASE_003:
    NAME: HANDLE_IMPERSONATION
    INPUT: "@јenkins_ci" (Cyrillic ј in a handle)
    CONTEXT: impersonating a project account in a chat/social platform
    RISK: HIGH
    ATTACK: the look-alike handle appears as jenkins_ci but is a different account
  ...
  RISK_CASE_005:
    ...
    CONTEXT: a phishing email from the "same" project
    RISK: HIGH
  ...
  RISK_CASE_006:
    ...
    RISK: HIGH
    ATTACK: a chain of look-alikes imitates the whole Latin keyword/name
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_J ≠ CYRILLIC_JE (the primary impersonation target; visually identical in many fonts)
  CONFUSABLE_002:
    VISIBLE_FORM: ϳ
    CODEPOINT: U+03F3
    NAME: GREEK LETTER YOT
    RISK: MEDIUM
    RULE: GREEK_YOT ≠ CYRILLIC_JE (a Greek j-like letter; a third-script look-alike)
  CONFUSABLE_003:
    VISIBLE_FORM: ј
    CODEPOINT: U+0575
    NAME: ARMENIAN SMALL LETTER YIWN
    RISK: MEDIUM
    RULE: ARMENIAN_YIWN ≠ CYRILLIC_JE (an Armenian j-like letter; another script)
  CONFUSABLE_004:
    VISIBLE_FORM: 𝗃
    CODEPOINT: U+1D5C3
    NAME: MATHEMATICAL SANS-SERIF SMALL J
    RISK: MEDIUM
    RULE: MATH_SANS_J ≠ CYRILLIC_JE (a math-alphanumeric styled Latin j used to dodge simple filters)
  CONFUSABLE_005:
    VISIBLE_FORM: ｊ
    CODEPOINT: U+FF4A
    NAME: FULLWIDTH LATIN SMALL LETTER J
    RISK: LOW
    RULE: FULLWIDTH_J ≠ CYRILLIC_JE (a full-width Latin j; a different compatibility form)
  CONFUSABLE_006:
    VISIBLE_FORM: ĵ
    CODEPOINT: U+0135
    NAME: LATIN SMALL LETTER J WITH CIRCUMFLEX
    RISK: LOW
    RULE: LATIN_J_CIRCUMFLEX ≠ CYRILLIC_JE (an accented Latin twin)
...
CONTRADICTION_GUARDS:
  ...
  CG3:
    ...
    RULE: in single-script Serbian/Macedonian text the letter is legit; the spoof is a MIX of scripts in one token
  CG4:
  ...
  CG6:
    ...
    RULE: in a domain/login/token/package the swap changes the entity the string resolves to
...
SEQUENCE_LAYER_BOUNDARY:
  ...
  SEQUENCE_CANDIDATES:
    SC1:
      ...
      RISK_LEVEL: CRITICAL
      POSSIBLE_CONTEXTS: IDN/brand/package spoof; the key signal is a SCRIPT MIX within one token
      REQUIRES_SEQUENCE_INTEGRATOR: YES
    SC2:
      SEQUENCE: "јаvascript" (several Cyrillic among Latin)
      NAME: MULTI_HOMOGLYPH_TOKEN
      RISK_LEVEL: HIGH
      POSSIBLE_CONTEXTS: multiple substitution onto a target keyword/brand
      REQUIRES_SEQUENCE_INTEGRATOR: YES
...
PHAGO_ENTITY_MIMICRY:
  PE_001:
    ...
    RISK: CRITICAL
    NOTE: Cyrillic ј mimics the NAME itself of a verified project/brand (not merely structure) — direct mimicry of an entity's existence. This is why the registry flags the sign PHAGO ●; commercial lookalike defenses often miss this class.
  PE_002:
    INPUT: "јsonwebtoken (package)"
    TYPE: PHAGO_ENTITY_MIMICRY
    RISK: HIGH
    NOTE: impersonating an official package name via a look-alike in the name (supply-chain typosquat).
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: substitution of Latin j (U+006A) with Cyrillic ј (U+0458) in a brand/package name
  A2: mixing Cyrillic ј with Greek yot ϳ / math sans-serif j to complicate detection
CATEGORY_B: CONTEXT_INJECTION (2)
  B1: Cyrillic ј bypasses a Latin-keyword blocklist (јackpot)
  B2: Cyrillic ј in a mail domain (team@projeсt-јoin.example) for phishing
CATEGORY_C: SEQUENCE_MANIPULATION (2)
  C1: the mixed token `јquery` (SC1) — scripts within one word
  C2: multiple substitution `јаvascript` (SC2) onto a target keyword
CATEGORY_D: SEMANTIC_MIMICRY (2)
  D1: the handle `@јenkins_ci` imitates a project account
  D2: "јoin-official" — a look-alike in a pseudo-official name
CATEGORY_E: PHAGO_ENTITY_MIMICRY (2)
  E1: `јquery.com` — mimicry of a project/brand name (PE_001)
  E2: `јsonwebtoken` — mimicry of an official package (PE_002)
...
============================================================
OQ1:
  QUESTION: how to distinguish legit single-script Serbian/Macedonian text from a spoof without false positives?
...
OQ2:
  QUESTION: is the full UTS #39 confusables table + a brand/package corpus needed for the whole-script case?
  STATUS: OPEN
  BLOCKS_WORKINGLY_CLOSED: NO
