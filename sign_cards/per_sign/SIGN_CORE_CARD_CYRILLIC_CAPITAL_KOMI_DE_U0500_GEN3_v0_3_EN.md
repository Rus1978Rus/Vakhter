...
DOCUMENT_ID: SIGN_CORE_CARD_CYRILLIC_CAPITAL_KOMI_DE_U0500_GEN3_v0_3_EN
...
TRANSLATION_NOTE: English mirror of SIGN_CORE_CARD_CYRILLIC_CAPITAL_KOMI_DE_U0500_GEN3_v0_3_RU (authoritative). Codepoints, field names and formulas identical. Homoglyph sign: core law is LOOKS_SAME ≠ IS_SAME. DRAFT for our work (Vakhter); conveyor is a separate project.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_CYRILLIC_CAPITAL_KOMI_DE_U0500_GEN3_v0_3_EN
CODEPOINT: U+0500
VISIBLE_FORM: Ԁ
...
DISPLAY_NAME: Cyrillic "Ԁ" capital Komi De (homoglyph of Latin capital D)
...
SIGN_CATEGORY:
  - Cyrillic capital Komi De — a letter of the Komi (Molodtsov) alphabet (sounds /d/)
  - homoglyph of Latin capital "D" (U+0044)
  - potential carrier of homoglyph / IDN spoofing when scripts are mixed

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_CAPITAL_D — Cyrillic Ԁ (U+0500) is NOT Latin D (U+0044); a different codepoint in the Komi (Molodtsov) alphabet (sounds /d/)
...
SAFE_CASES:
  SAFE_CASE_001:
    INPUT: "Ԁона" (single-script Cyrillic)
  ...
  SAFE_CASE_004:
    ...
    GUARD: CYRILLIC_CAPITAL_KOMI_DE_FORM ≠ EFFECT
  SAFE_CASE_005:
    INPUT: "Ԁона мора" (single-script Cyrillic)
    CONTEXT: single-script native text
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAPITAL_KOMI_DE_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_006:
    INPUT: "Ԁуман" (single-script Cyrillic)
    CONTEXT: single-script native text
    EXPECTED: INFO
    RISK: NONE
    GUARD: CYRILLIC_CAPITAL_KOMI_DE_FORM ≠ AUTOMATICALLY_SPOOF
...
RISK_CASES:
  ...
  RISK_CASE_002:
    ...
    INPUT: "Ԁell" (a look-alike inside the token `Dell`)
    CONTEXT: a look-alike inside the token `Dell`
    RISK: CRITICAL
    ATTACK: the string is machine-≠ Dell, but a human sees no difference
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_CAPITAL_LETTER_D ≠ CYRILLIC_CAPITAL_KOMI_DE_FORM (the primary impersonation target; visually identical in many fonts)
  CONFUSABLE_002:
    VISIBLE_FORM: Ｄ
    CODEPOINT: U+FF24
    NAME: FULLWIDTH LATIN CAPITAL LETTER D
    RISK: MEDIUM
    RULE: FULLWIDTH_LATIN_CAPITAL_LETTER_D ≠ CYRILLIC_CAPITAL_KOMI_DE_FORM (a full-width Latin form; a different compatibility form)
  CONFUSABLE_003:
    VISIBLE_FORM: 𝖣
    CODEPOINT: U+1D5A3
    NAME: MATHEMATICAL SANS-SERIF CAPITAL D
    RISK: MEDIUM
    RULE: MATHEMATICAL_SANS_SERIF_CAPITAL_D ≠ CYRILLIC_CAPITAL_KOMI_DE_FORM (a math-alphanumeric styled Latin letter used to dodge simple filters)
  CONFUSABLE_004:
    VISIBLE_FORM: 𝐃
    CODEPOINT: U+1D403
    NAME: MATHEMATICAL BOLD CAPITAL D
    RISK: LOW
    RULE: MATHEMATICAL_BOLD_CAPITAL_D ≠ CYRILLIC_CAPITAL_KOMI_DE_FORM (a bold-styled Latin letter)
  CONFUSABLE_005:
    VISIBLE_FORM: 𝐷
    CODEPOINT: U+1D437
    NAME: MATHEMATICAL ITALIC CAPITAL D
    RISK: LOW
    RULE: MATHEMATICAL_ITALIC_CAPITAL_D ≠ CYRILLIC_CAPITAL_KOMI_DE_FORM (an italic-styled Latin letter)
  CONFUSABLE_006:
    VISIBLE_FORM: 𝙳
    CODEPOINT: U+1D673
    NAME: MATHEMATICAL MONOSPACE CAPITAL D
    RISK: LOW
    RULE: MATHEMATICAL_MONOSPACE_CAPITAL_D ≠ CYRILLIC_CAPITAL_KOMI_DE_FORM (a monospace-styled Latin letter)
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: substitution of Latin D (U+0044) with Cyrillic Ԁ (U+0500) in a brand domain
