...
DOCUMENT_ID: SIGN_CORE_CARD_ROMAN_CAPITAL_X_U2169_GEN3_v0_3_EN
...
TRANSLATION_NOTE: English mirror of SIGN_CORE_CARD_ROMAN_CAPITAL_X_U2169_GEN3_v0_3_RU (authoritative). Codepoints, field names and formulas identical. Homoglyph sign: core law is LOOKS_SAME ≠ IS_SAME. DRAFT for our work (Vakhter); conveyor is a separate project.
...
2. META
============================================================
CARD_UID: SIGN_CORE_CARD_ROMAN_CAPITAL_X_U2169_GEN3_v0_3_EN
CODEPOINT: U+2169
VISIBLE_FORM: Ⅹ
...
DISPLAY_NAME: Roman numeral "Ⅹ" ten (homoglyph of Latin capital X)
...
SIGN_CATEGORY:
  - Roman-numeral letter-form "roman numeral ten" (means 10 as a standalone numeral; a Number Forms character)
  - homoglyph of Latin capital "X" (U+0058)
  - potential carrier of homoglyph spoofing when mixed INTO a Latin word

WHAT_THIS_SIGN_IS_NOT:
  1. NOT_LATIN_CAP_X — Roman Ⅹ (U+2169) is NOT Latin X (U+0058); a different codepoint AND a numeral (value 10), not a letter
...
SAFE_CASES:
  ...
  SAFE_CASE_002:
    INPUT: "Louis Ⅹ" (Louis the Tenth, Roman numeral)
  ...
  SAFE_CASE_004:
    ...
    GUARD: ROMAN_CAP_X_FORM ≠ EFFECT
  SAFE_CASE_005:
    INPUT: "Ⅸ and Ⅹ" (9 and 10, Roman numerals)
    CONTEXT: all-Roman-numeral tokens
    EXPECTED: INFO
    RISK: NONE
    GUARD: ROMAN_CAP_X_FORM ≠ AUTOMATICALLY_SPOOF
  SAFE_CASE_006:
    INPUT: "Super Bowl Ⅹ" (Super Bowl 10, Roman numeral)
...
RISK_CASES:
  ...
  RISK_CASE_002:
    ...
    INPUT: "ⅩRP-crypto-deal.com" (Roman Ⅹ in an all-caps brand)
    CONTEXT: leading substitution in an all-caps brand phrase
    RISK: CRITICAL
    ATTACK: the string is machine-≠ XRP, but a human sees no difference
    GUARD: ROMAN_CAP_X_FORM ≠ DOMAIN_VALIDITY_PROOF
  RISK_CASE_003:
    NAME: HANDLE_IMPERSONATION
    INPUT: "@ⅩeroHelp" (Roman Ⅹ in a handle)
    CONTEXT: impersonating a brand account in a chat/social platform
    RISK: HIGH
    ATTACK: the look-alike handle appears as XeroHelp but is a different account
    GUARD: ROMAN_CAP_X_FORM ≠ VERIFICATION
  RISK_CASE_004:
    NAME: FILTER_BYPASS_KEYWORD
    INPUT: "ⅩML" (Roman Ⅹ bypasses an "XML" blocklist)
  ...
  RISK_CASE_005:
    ...
    INPUT: "no-reply@ⅩFINITY-secure.example" (Roman Ⅹ in the mail domain)
  ...
  RISK_CASE_006:
    ...
    CONTEXT: multiple substitutions in one all-caps token (Ⅹ Roman, ERO Latin — a numeral-in-word mix)
    RISK: HIGH
...
CONFUSABLES:
  CONFUSABLE_001:
    ...
    RISK: CRITICAL
    RULE: LATIN_CAP_X ≠ ROMAN_CAP_X (the primary impersonation target; visually identical in many fonts)
  CONFUSABLE_002:
    VISIBLE_FORM: Х
    CODEPOINT: U+0425
    NAME: CYRILLIC CAPITAL LETTER HA
    RISK: HIGH
    RULE: CYRILLIC_CAP_HA ≠ ROMAN_CAP_X (another script with the same X-shape; complicates detection)
  CONFUSABLE_003:
    VISIBLE_FORM: Ｘ
    CODEPOINT: U+FF38
    NAME: FULLWIDTH LATIN CAPITAL LETTER X
    RISK: MEDIUM
    RULE: FULLWIDTH_CAP_X ≠ ROMAN_CAP_X (a full-width Latin X; a different compatibility form)
  CONFUSABLE_004:
    VISIBLE_FORM: 𝗫
    CODEPOINT: U+1D5EB
    NAME: MATHEMATICAL SANS-SERIF BOLD CAPITAL X
    RISK: MEDIUM
    RULE: MATH_SANS_CAP_X ≠ ROMAN_CAP_X (a math-alphanumeric styled Latin X used to dodge simple filters)
  CONFUSABLE_005:
    VISIBLE_FORM: 𝐗
    CODEPOINT: U+1D417
    NAME: MATHEMATICAL BOLD CAPITAL X
    RISK: LOW
    RULE: MATH_BOLD_CAP_X ≠ ROMAN_CAP_X (a bold-styled Latin X)
  CONFUSABLE_006:
    VISIBLE_FORM: 𝑋
    CODEPOINT: U+1D44B
    NAME: MATHEMATICAL ITALIC CAPITAL X
    RISK: LOW
    RULE: MATH_ITALIC_CAP_X ≠ ROMAN_CAP_X (an italic-styled Latin X)
...
CONTRADICTION_GUARDS:
  ...
  CG5:
    TRIGGER: "the handle `@ⅩeroHelp` is the same account as @XeroHelp"
...
SEQUENCE_LAYER_BOUNDARY:
  ...
  SEQUENCE_CANDIDATES:
    ...
    SC2:
      SEQUENCE: "ⅩEROⅩ" (two Roman Ⅹ among Latin capitals)
...
CATEGORY_A: FORM_MANIPULATION (2)
  A1: substitution of Latin X (U+0058) with Roman Ⅹ (U+2169) in a brand domain
  A2: mixing Roman Ⅹ with Cyrillic Ha Х / math sans-serif X to complicate detection
CATEGORY_B: CONTEXT_INJECTION (2)
  B1: Roman Ⅹ bypasses a Latin-keyword blocklist (ⅩML)
  B2: Roman Ⅹ in a mail domain (no-reply@ⅩFINITY-secure.example) for phishing
...
CATEGORY_D: SEMANTIC_MIMICRY (2)
  D1: the handle `@ⅩeroHelp` imitates a brand account
  D2: "ⅩFINITY-secure" — a look-alike in a pseudo-official name
CATEGORY_E: PHAGO_ENTITY_MIMICRY (2)
  E1: `ⅩBOX-deals.com` — mimicry of a brand name (PE_001)
  E2: `@ⅩeroHelp` — mimicry of an official account (PE_002)
...
MUTATION_03:
  ...
  RESULT: FAIL
MUTATION_04:
  CLAIM: an ASCII filter on "XML" will catch "ⅩML"
  EXPECTED: FAIL_ASCII_COVERAGE_MIMICRY
  RESULT: FAIL
MUTATION_05:
  CLAIM: the handle `@ⅩeroHelp` is the same account as `@XeroHelp`
